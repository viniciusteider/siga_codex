			...
			form,
			{
				fields: {					 
                    ...
                    'confirm-password': {
                        validators: {
                            notEmpty: {
                                message: 'A confirmação de senha é necessária'
                            },
                            identical: {
                                compare: function() {
            ...
            validator.validate().then(function(status) {
		        if (status == 'Valid') {
                    ...
                    var dados ={
                        ...
                        "hash" :form.querySelector('[name="hash"]').value
                    }

                    var url   = 'index.php?app_modulo=login&app_comando=salvar_nova_senha';
                    $.post(url, dados,
                        function (data)
                        {
                            ...
                            if (data['codigo'] > 0) {
                                ...
                                Swal.fire({
                                    text: "Sucesso ao modificar senha, agora você será redirecionado para o Login!",
                                    icon: "success",
                                    buttonsStyling: false,
                                    confirmButtonText: "Ok",
                                    customClass: {
