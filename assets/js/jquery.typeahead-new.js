...
;(function (factory) {
    ...
    var _options = {
        ...
        filter: false,           // -> New feature, set to false or function to bypass Typeahead filtering. WARNING: accent, correlativeTemplate, offset & matcher will not be interpreted
    ...
    Typeahead.prototype = {
        ...
        extendOptions: function () {
            ...
            if (typeof this.options.accent !== "undefined") {
        ...
        handleRequests: function () {
            ...
            for (var group in this.requests) {
                ...
                (function (group, xhrObject) {
                    ...
                    //Comando adicionado para adicionar o parametro $_GET['buscar'] à url antes de realizar o request
                    if (xhrObject.request.url.indexOf("&buscar=") >= 0)
                        xhrObject.request.url = xhrObject.request.url.substring(0, xhrObject.request.url.indexOf("&buscar=")) + "&buscar=" + encodeURI($("#"+scope.node[0].id).val());
                    else
                        xhrObject.request.url += "&buscar=" + encodeURI($("#"+scope.node[0].id).val());

                    //Objetos selecionados
                    var dataArray = $("#" + scope.options.linkedTo).val();
                    ...
                    if (dataArray !== null) {
                        xhrObject.request.data = {
                            selecionados: dataArray
                        };

                        xhrObject.request.type = "POST";
                    }
        ...
        helper: {
            ...
            removeAccent: function (string) {
                ...
                if (typeof this.options.accent.from !== "undefined") {
     ...
     */
    $.fn.typeahead_updated = $.typeahead_updated = function (options) {
        return _api.typeahead_updated(this, options);
    };
    ...
    var _api = {
         ...
         * @returns {*}
         */
        typeahead_updated: function (node, options) {
