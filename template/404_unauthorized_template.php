        ...
        <div class="col-lg-6 col-xl-4 mb-4">
            <div class="my-5 pt-5">
                ...
                <div class="text-center">
                    <h1>Erro 404 !</h1>
                    <h2 class="text-uppercase text-primary mt-4">Arquivos de Template não encontrato</h2>
                    <p class="text-muted mt-4 ">Verifique neste módulo a ação se o arquivo correspondete ao template existe. ou se não esta escrito diferente do nome do arquivo</p>
