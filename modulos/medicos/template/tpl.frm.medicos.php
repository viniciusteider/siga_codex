...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Médicos</h3>
        ...
        <div class="card-body" id="formulario_medicos">
        <?php include_once("modulos/medicos/template/tpl.form.medicos.php");?>
...
<?php
include_once("modulos/medicos/template/js.frm.medicos.php");
?>
