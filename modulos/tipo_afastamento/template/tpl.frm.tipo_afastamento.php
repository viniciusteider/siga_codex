...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Tipos de Afastamentos</h3>
        ...
        <div class="card-body" id="formulario_tipo_afastamento">
        <?php include_once("modulos/tipo_afastamento/template/tpl.form.tipo_afastamento.php");?>
...
<?php
include_once("modulos/tipo_afastamento/template/js.frm.tipo_afastamento.php");
?>
