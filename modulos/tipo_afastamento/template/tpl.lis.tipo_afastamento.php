<?php
include_once("modulos/tipo_afastamento/template/js.lis.tipo_afastamento.php");
$_SESSION["FILTRO_TIPO_AFASTAMENTO"] = $_REQUEST;
...
$objTipoAfastamento = new TipoAfastamento();
$listar = $objTipoAfastamento->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_tipo_afastamento";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["tipo_afastamento"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridTipoAfastamento";
$grid->funcao_modificar = "ModificarTipoAfastamento";
