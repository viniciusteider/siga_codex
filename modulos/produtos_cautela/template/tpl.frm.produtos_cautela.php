...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Produtos Cautela</h3>
        ...
        <div class="card-body" id="formulario_produtos_cautela">
        <?php include_once("modulos/produtos_cautela/template/tpl.form.produtos_cautela.php");?>
...
<?php
include_once("modulos/produtos_cautela/template/js.frm.produtos_cautela.php");
?>
