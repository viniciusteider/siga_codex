...
$listar = $objUniformePeca->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Uniforme_peca;
//$filtro[ROTULO_RELATORIO] = Uniforme_peca;
...
header("Content-Disposition: attachment;filename=".Uniforme_peca.".xls");
