<?php
include_once("modulos/uniforme_peca/template/js.lis.uniforme_peca.php");
$_SESSION["FILTRO_UNIFORME_PECA"] = $_REQUEST;
...
$objUniformePeca = new UniformePeca();
$listar = $objUniformePeca->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_uniforme_peca";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["uniforme_peca"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = true;
$grid->funcao_atualizar = "AtualizarGridUniformePeca";
$grid->funcao_modificar = "ModificarUniformePeca";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroUniformePeca";
$grid->id_botao_excluir = "ExcluirRegistroUniformePeca";
$grid->id_checkbox_master = "master_UniformePeca";
$grid->nome_lista_checkbox = "lista_UniformePeca";
$grid->pagina = $pagina;
