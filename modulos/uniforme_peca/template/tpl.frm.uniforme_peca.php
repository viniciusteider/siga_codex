...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Uniformes Peças</h3>
        ...
        <div class="card-body" id="formulario_uniforme_peca">
        <?php include_once("modulos/uniforme_peca/template/tpl.form.uniforme_peca.php");?>
...
<?php
include_once("modulos/uniforme_peca/template/js.frm.uniforme_peca.php");
?>
