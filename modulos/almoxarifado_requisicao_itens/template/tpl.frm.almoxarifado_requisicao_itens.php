...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Almoxarifado Requisicao Itens</h3>
        ...
        <div class="card-body" id="formulario_almoxarifado_requisicao_itens">
        <?php include_once("modulos/almoxarifado_requisicao_itens/template/tpl.form.almoxarifado_requisicao_itens.php");?>
...
<?php
include_once("modulos/almoxarifado_requisicao_itens/template/js.frm.almoxarifado_requisicao_itens.php");
?>
