<?php
include_once("modulos/procedimentos_tipo/template/js.lis.procedimentos_tipo.php");
$_SESSION["FILTRO_PROCEDIMENTOS_TIPO"] = $_REQUEST;
...
$objProcedimentosTipo = new ProcedimentosTipo();
$listar = $objProcedimentosTipo->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_procedimentos_tipo";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["procedimentos_tipo"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridProcedimentosTipo";
$grid->funcao_modificar = "ModificarProcedimentosTipo";
