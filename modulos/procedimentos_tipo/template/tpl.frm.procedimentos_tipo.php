...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Tipos de Procedimentos</h3>
        ...
        <div class="card-body" id="formulario_procedimentos_tipo">
        <?php include_once("modulos/procedimentos_tipo/template/tpl.form.procedimentos_tipo.php");?>
...
<?php
include_once("modulos/procedimentos_tipo/template/js.frm.procedimentos_tipo.php");
?>
