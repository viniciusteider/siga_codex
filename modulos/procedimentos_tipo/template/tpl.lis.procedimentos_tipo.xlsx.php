...
$listar = $objProcedimentosTipo->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Procedimentos_tipo;
//$filtro[ROTULO_RELATORIO] = Procedimentos_tipo;
...
header("Content-Disposition: attachment;filename=".Procedimentos_tipo.".xls");
