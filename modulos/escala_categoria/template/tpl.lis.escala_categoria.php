<?php
include_once("modulos/escala_categoria/template/js.lis.escala_categoria.php");
$_SESSION["FILTRO_ESCALA_CATEGORIA"] = $_REQUEST;
...
$objEscalaCategoria = new EscalaCategoria();
$listar = $objEscalaCategoria->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_escala_categoria";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["escala_categoria"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridEscalaCategoria";
$grid->funcao_modificar = "ModificarEscalaCategoria";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroEscalaCategoria";
$grid->id_botao_excluir = "ExcluirRegistroEscalaCategoria";
$grid->id_checkbox_master = "master_EscalaCategoria";
$grid->nome_lista_checkbox = "lista_EscalaCategoria";
$grid->pagina = $pagina;
