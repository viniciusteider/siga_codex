...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Escala Categoria</h3>
        ...
        <div class="card-body" id="formulario_escala_categoria">
        <?php include_once("modulos/escala_categoria/template/tpl.form.escala_categoria.php");?>
...
<?php
include_once("modulos/escala_categoria/template/js.frm.escala_categoria.php");
?>
