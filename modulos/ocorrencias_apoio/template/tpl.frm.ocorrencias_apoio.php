...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Ocorrencias Apoio</h3>
        ...
        <div class="card-body" id="formulario_ocorrencias_apoio">
        <?php include_once("modulos/ocorrencias_apoio/template/tpl.form.ocorrencias_apoio.php");?>
...
<?php
include_once("modulos/ocorrencias_apoio/template/js.modal.frm.ocorrencias_apoio.php");
?>
