    ...
    <div class="card shadow-sm">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a href='#index_xml.php?app_modulo=recursos&app_comando=listar_recursos'  class="btn btn-sm btn-light "> <i class="fas fa-arrow-circle-left"></i> Voltar para listagem</a>
            </div>
        </div>
                    ...
                    <div class="row p-t-20">
                        <div class="col-md-4 mb-2">
                            <div class="form-group">
                                ...
                                <?php
                                $objPrefixo   = new Prefixo();
                                $registros = $objPrefixo->ComboPrefixos();
                                echo Componente::GerarSelectPDO("prefixo", "prefixo", "", $registros, array($linha['prefixo']), array('','Selecione um Prefixo'), array("id", "nome"), false, 'form-select  m-b-20 m-r-10','data-validar="select2"');
                                ?>
                        ...
                        <div class="col-md-3 mb-2">
                            <div class="form-group">
                                ...
                                <div class="text-muted"> Preencha o campo  Id Modelo </div> </div>
                        </div>
                        <!--/span-->
                        <div class="col-md-3 mb-2">
                            <div class="form-group">
                        ...
                        <div class="col-md-3 mb-2">
                            <div class="form-group">
                                <label class="form-label" for="ano_fabricacao">Ano Fabricacao</label>
                                ...
                                <div class="text-muted"> Preencha o campo  Ano Fabricacao </div> </div>
                        </div>
                        <!--/span-->
                        ...
                        <div class="col-md-2 mb-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="cor"  id="cor" maxlength="10" class="form-control  " value="<?=$linha['cor'];?>"/>
                        ...
                        <div class="col-md-2 mb-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="data_carga"  id="data_carga"  class="form-control  mask-datetime" value="<?=$linha['data_carga'];?>"/>
