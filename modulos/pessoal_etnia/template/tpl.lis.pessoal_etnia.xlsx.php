...
$listar = $objPessoalEtnia->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Pessoal_etnia;
//$filtro[ROTULO_RELATORIO] = Pessoal_etnia;
...
header("Content-Disposition: attachment;filename=".Pessoal_etnia.".xls");
