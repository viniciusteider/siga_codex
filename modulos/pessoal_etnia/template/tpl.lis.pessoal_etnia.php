<?php
include_once("modulos/pessoal_etnia/template/js.lis.pessoal_etnia.php");
$_SESSION["FILTRO_PESSOAL_ETNIA"] = $_REQUEST;
...
$objPessoalEtnia = new PessoalEtnia();
$listar = $objPessoalEtnia->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_pessoal_etnia";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["pessoal_etnia"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridPessoalEtnia";
$grid->funcao_modificar = "ModificarPessoalEtnia";
