...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Paciente Pupilas</h3>
        ...
        <div class="card-body" id="formulario_paciente_pupilas">
        <?php include_once("modulos/paciente_pupilas/template/tpl.form.paciente_pupilas.php");?>
...
<?php
include_once("modulos/paciente_pupilas/template/js.frm.paciente_pupilas.php");
?>
