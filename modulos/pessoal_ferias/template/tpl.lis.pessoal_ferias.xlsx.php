...
$listar = $objPessoalFerias->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Pessoal_ferias;
//$filtro[ROTULO_RELATORIO] = Pessoal_ferias;
...
header("Content-Disposition: attachment;filename=".Pessoal_ferias.".xls");
