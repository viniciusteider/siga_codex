...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Pessoal Ferias</h3>
        ...
        <div class="card-body" id="formulario_pessoal_ferias">
        <?php include_once("modulos/pessoal_ferias/template/tpl.form.pessoal_ferias.php");?>
...
<?php
include_once("modulos/pessoal_ferias/template/js.frm.pessoal_ferias.php");
?>
