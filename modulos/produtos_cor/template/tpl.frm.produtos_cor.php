...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Produtos Cor</h3>
        ...
        <div class="card-body" id="formulario_produtos_cor">
        <?php include_once("modulos/produtos_cor/template/tpl.form.produtos_cor.php");?>
...
<?php
include_once("modulos/produtos_cor/template/js.frm.produtos_cor.php");
?>
