<?php
include_once("modulos/produtos_cor/template/js.lis.produtos_cor.php");
$_SESSION["FILTRO_PRODUTOS_COR"] = $_REQUEST;
...
$listar = $objProdutosCor->ListarPaginacao($parametros);
...
$dados_tabela["id"]    = "id_tabela_produtos_cor";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["produtos_cor"]);
$grid = new SquallTable();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = true;
$grid->funcao_atualizar = "AtualizarGridProdutosCor";
$grid->funcao_modificar = "ModificarProdutosCor";
$grid->id_botao_adicionar = "AdicionarRegistroProdutosCor";
$grid->id_botao_excluir = "ExcluirRegistroProdutosCor";
$grid->id_checkbox_master = "master_ProdutosCor";
$grid->nome_lista_checkbox = "lista_ProdutosCor";
