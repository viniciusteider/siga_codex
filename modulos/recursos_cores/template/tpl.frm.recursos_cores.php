...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Recursos Cores</h3>
        ...
        <div class="card-body" id="formulario_recursos_cores">
        <?php include_once("modulos/recursos_cores/template/tpl.form.recursos_cores.php");?>
...
<?php
include_once("modulos/recursos_cores/template/js.frm.recursos_cores.php");
?>
