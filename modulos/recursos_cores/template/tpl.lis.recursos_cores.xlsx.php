...
$listar = $objRecursosCores->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Recursos_cores;
//$filtro[ROTULO_RELATORIO] = Recursos_cores;
...
header("Content-Disposition: attachment;filename=".Recursos_cores.".xls");
