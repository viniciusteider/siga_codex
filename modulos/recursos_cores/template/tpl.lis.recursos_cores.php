<?php
include_once("modulos/recursos_cores/template/js.lis.recursos_cores.php");
$_SESSION["FILTRO_RECURSOS_CORES"] = $_REQUEST;
...
$objRecursosCores = new RecursosCores();
$listar = $objRecursosCores->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_recursos_cores";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["recursos_cores"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = true;
$grid->funcao_atualizar = "AtualizarGridRecursosCores";
$grid->funcao_modificar = "ModificarRecursosCores";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroRecursosCores";
$grid->id_botao_excluir = "ExcluirRegistroRecursosCores";
$grid->id_checkbox_master = "master_RecursosCores";
$grid->nome_lista_checkbox = "lista_RecursosCores";
$grid->pagina = $pagina;
