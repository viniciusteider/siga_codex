...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Pessoal Curso</h3>
        ...
        <div class="card-body" id="formulario_pessoal_curso">
        <?php include_once("modulos/pessoal_curso/template/tpl.form.pessoal_curso.php");?>
...
<?php
include_once("modulos/pessoal_curso/template/js.frm.pessoal_curso.php");
?>
