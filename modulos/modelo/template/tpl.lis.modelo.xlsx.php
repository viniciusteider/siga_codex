...
$listar = $objModelo->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Modelo;
//$filtro[ROTULO_RELATORIO] = Modelo;
...
header("Content-Disposition: attachment;filename=".Modelo.".xls");
