...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Cid</h3>
        ...
        <div class="card-body" id="formulario_cid">
        <?php include_once("modulos/cid/template/tpl.form.cid.php");?>
...
<?php
include_once("modulos/cid/template/js.frm.cid.php");
?>
