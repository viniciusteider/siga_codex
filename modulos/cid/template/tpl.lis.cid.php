<?php
include_once("modulos/cid/template/js.lis.cid.php");
$_SESSION["FILTRO_CID"] = $_REQUEST;
...
$objCid = new Cid();
$listar = $objCid->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "CAPÍTULO","filtro"=> "capitulo", "tipo"=> "$ordem"];
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "AGRUPAMENTO","filtro"=> "agrupamento", "tipo"=> "$ordem"];
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "CATEGORIA","filtro"=> "categoria", "tipo"=> "$ordem"];
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "SUB-CATEGORIA","filtro"=> "sub_categoria", "tipo"=> "$ordem"];
...
if(@count($listar[0])> 0){
	foreach($listar[0] as $linha){
		...
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["capitulo"]];
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["agrupamento"]];
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["categoria"]];
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["sub_categoria"]];
...
$grid->funcao_atualizar = "AtualizarGridCid";
$grid->funcao_modificar = "ModificarCid";
