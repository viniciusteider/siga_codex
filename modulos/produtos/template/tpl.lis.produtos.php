<?php
include_once("modulos/produtos/template/js.lis.produtos.php");
$_SESSION["FILTRO_PRODUTOS"] = $_REQUEST;
...
$dados_tabela["id"]    = "id_tabela_produtos";
...
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "ESTOQUE","filtro"=> "estoque_atual", "tipo"=> "$ordem"];
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "MÍNIMO","filtro"=> "estoque_minimo", "tipo"=> "$ordem"];
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "CUSTO","filtro"=> "custo", "tipo"=> "$ordem"];
...
if(@count($listar[0])> 0){
	foreach($listar[0] as $linha){
		...
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["estoque_minimo"]];
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["custo"]];
...
$grid->funcao_atualizar = "AtualizarGridProdutos";
$grid->funcao_modificar = "ModificarProdutos";
$grid->id_botao_adicionar = "AdicionarRegistroProdutos";
$grid->id_botao_excluir = "ExcluirRegistroProdutos";
$grid->id_checkbox_master = "master_Produtos";
$grid->nome_lista_checkbox = "lista_Produtos";
