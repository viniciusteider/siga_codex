...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Produtos</h3>
        ...
        <div class="card-body" id="formulario_produtos">
        <?php include_once("modulos/produtos/template/tpl.form.produtos.php");?>
...
<?php
include_once("modulos/produtos/template/js.frm.produtos.php");
?>
