...
$listar = $objDisponibilidade->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Disponibilidade;
//$filtro[ROTULO_RELATORIO] = Disponibilidade;
...
header("Content-Disposition: attachment;filename=".Disponibilidade.".xls");
