...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Disponibilidade</h3>
        ...
        <div class="card-body" id="formulario_disponibilidade">
        <?php include_once("modulos/disponibilidade/template/tpl.form.disponibilidade.php");?>
...
<?php
include_once("modulos/disponibilidade/template/js.frm.disponibilidade.php");
?>
