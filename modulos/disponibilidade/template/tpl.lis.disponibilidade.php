<?php
include_once("modulos/disponibilidade/template/js.lis.disponibilidade.php");
$_SESSION["FILTRO_DISPONIBILIDADE"] = $_REQUEST;
...
$listar = $objDisponibilidade->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_disponibilidade";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["disponibilidade"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = true;
$grid->funcao_atualizar = "AtualizarGridDisponibilidade";
$grid->funcao_modificar = "ModificarDisponibilidade";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroDisponibilidade";
$grid->id_botao_excluir = "ExcluirRegistroDisponibilidade";
$grid->id_checkbox_master = "master_Disponibilidade";
$grid->nome_lista_checkbox = "lista_Disponibilidade";
$grid->pagina = $pagina;
