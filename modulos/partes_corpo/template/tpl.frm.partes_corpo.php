...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Partes Corpo</h3>
        ...
        <div class="card-body" id="formulario_partes_corpo">
        <?php include_once("modulos/partes_corpo/template/tpl.form.partes_corpo.php");?>
...
<?php
include_once("modulos/partes_corpo/template/js.frm.partes_corpo.php");
?>
