...
$listar = $objPartesCorpo->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Partes_corpo;
//$filtro[ROTULO_RELATORIO] = Partes_corpo;
...
header("Content-Disposition: attachment;filename=".Partes_corpo.".xls");
