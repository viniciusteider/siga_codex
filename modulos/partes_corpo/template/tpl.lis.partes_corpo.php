<?php
include_once("modulos/partes_corpo/template/js.lis.partes_corpo.php");
$_SESSION["FILTRO_PARTES_CORPO"] = $_REQUEST;
...
$listar = $objPartesCorpo->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_partes_corpo";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["partes_corpo"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridPartesCorpo";
$grid->funcao_modificar = "ModificarPartesCorpo";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroPartesCorpo";
$grid->id_botao_excluir = "ExcluirRegistroPartesCorpo";
$grid->id_checkbox_master = "master_PartesCorpo";
$grid->nome_lista_checkbox = "lista_PartesCorpo";
$grid->pagina = $pagina;
