...
$listar = $objTiposSanguineos->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Tipos_sanguineos;
//$filtro[ROTULO_RELATORIO] = Tipos_sanguineos;
...
header("Content-Disposition: attachment;filename=".Tipos_sanguineos.".xls");
