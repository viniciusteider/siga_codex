...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Tipos Sanguineos</h3>
        ...
        <div class="card-body" id="formulario_tipos_sanguineos">
        <?php include_once("modulos/tipos_sanguineos/template/tpl.form.tipos_sanguineos.php");?>
...
<?php
include_once("modulos/tipos_sanguineos/template/js.frm.tipos_sanguineos.php");
?>
