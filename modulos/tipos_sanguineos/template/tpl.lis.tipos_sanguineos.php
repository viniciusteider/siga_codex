<?php
include_once("modulos/tipos_sanguineos/template/js.lis.tipos_sanguineos.php");
$_SESSION["FILTRO_TIPOS_SANGUINEOS"] = $_REQUEST;
...
$objTiposSanguineos = new TiposSanguineos();
$listar = $objTiposSanguineos->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_tipos_sanguineos";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["tipos_sanguineos"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridTiposSanguineos";
$grid->funcao_modificar = "ModificarTiposSanguineos";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroTiposSanguineos";
$grid->id_botao_excluir = "ExcluirRegistroTiposSanguineos";
$grid->id_checkbox_master = "master_TiposSanguineos";
$grid->nome_lista_checkbox = "lista_TiposSanguineos";
$grid->pagina = $pagina;
