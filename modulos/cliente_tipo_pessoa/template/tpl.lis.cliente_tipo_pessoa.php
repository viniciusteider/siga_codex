<?
include_once("modulos/cliente_tipo_pessoa/template/js.lis.cliente_tipo_pessoa.php");
...
$dados_tabela["id"]    = "id_tabela_cliente_tipo_pessoa";
...
$grid->titulo = "";
$grid->funcao_atualizar = "AtualizarGridClienteTipoPessoa";
$grid->funcao_modificar = "ModificarClienteTipoPessoa";
