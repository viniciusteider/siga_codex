...
$listar = $objMateriaisItens->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["materiais_itens"]);

$filtro[ROTULO_LISTAGEM] = Materiais_itens;
//$filtro[ROTULO_RELATORIO] = Materiais_itens;
...
header("Content-Disposition: attachment;filename=".Materiais_itens.".xls");
