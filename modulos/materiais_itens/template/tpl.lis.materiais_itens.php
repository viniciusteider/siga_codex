<?php
include_once("modulos/materiais_itens/template/js.lis.materiais_itens.php");
$_SESSION["FILTRO_MATERIAIS_ITENS"] = $_REQUEST;
...
$listar = $objMateriaisItens->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_materiais_itens";
...
$grid->funcao_atualizar = "AtualizarGridMateriaisItens";
$grid->funcao_modificar = "ModificarMateriaisItens";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroMateriaisItens";
$grid->id_botao_excluir = "ExcluirRegistroMateriaisItens";
$grid->id_checkbox_master = "master_MateriaisItens";
$grid->nome_lista_checkbox = "lista_MateriaisItens";
$grid->pagina = $pagina;
