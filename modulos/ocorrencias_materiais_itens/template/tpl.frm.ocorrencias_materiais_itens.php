...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Ocorrencias Materiais Itens</h3>
        ...
        <div class="card-body" id="formulario_ocorrencias_materiais_itens">
        <?php include_once("modulos/ocorrencias_materiais_itens/template/tpl.form.ocorrencias_materiais_itens.php");?>
...
<?php
include_once("modulos/ocorrencias_materiais_itens/template/js.frm.ocorrencias_materiais_itens.php");
?>
