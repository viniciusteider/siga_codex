<?php
include_once("modulos/ocorrencias_materiais_itens/template/js.lis.ocorrencias_materiais_itens.php");
$_SESSION["FILTRO_OCORRENCIAS_MATERIAIS_ITENS"] = $_REQUEST;
...
$listar = $objOcorrenciasMateriaisItens->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_ocorrencias_materiais_itens";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["ocorrencias_materiais_itens"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridOcorrenciasMateriaisItens";
$grid->funcao_modificar = "ModificarOcorrenciasMateriaisItens";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroOcorrenciasMateriaisItens";
$grid->id_botao_excluir = "ExcluirRegistroOcorrenciasMateriaisItens";
$grid->id_checkbox_master = "master_OcorrenciasMateriaisItens";
$grid->nome_lista_checkbox = "lista_OcorrenciasMateriaisItens";
$grid->pagina = $pagina;
