...
$listar = $objOcorrenciasMateriaisItens->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Ocorrencias_materiais_itens;
//$filtro[ROTULO_RELATORIO] = Ocorrencias_materiais_itens;
...
header("Content-Disposition: attachment;filename=".Ocorrencias_materiais_itens.".xls");
