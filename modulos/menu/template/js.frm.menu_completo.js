...
var MenusCompletos = function (){
    return{
        init:function (){
            ...
            $("#bt_salvar2").click(function () {
                if ($('#id').val() > 0 )
                    url = "index_xml.php?app_modulo=menu&app_comando=atualizar_menu&app_codigo";
                else
                    url = "index_xml.php?app_modulo=menu&app_comando=adicionar_menu_completo&app_codigo";

                MenusCompletos.ExecutarAcao(url);
            });

            // $('#target,#index,#id_acao,#id_pai').select2({language: "pt-BR"});
            $('#target,#index,#id_acao,#id_pai,#dir').select2({language: "pt-BR"});
            campo_icone.select2({
                templateSelection: MenusCompletos.formatText,
                templateResult: MenusCompletos.formatText
            });
        ...
        ExecutarAcao : function (url) {
            if (Squall.ValidateForm($("#frm_menu_completo"))) {
                console.log('entrou aqui');
                $("#bt_salvar2").prop("disabled",true).html("<i class=\"fa fa-spin fa-spinner\"></i> AGUARDE...").addClass("btn-warning");
                // ao clicar em salvar enviando dados por post via AJAX
                $.post(url,
                    $("#frm_menu_completo").serialize(),
                    ...
                    function (response)
                    {
                        ...
                        $("#bt_salvar2").prop("disabled",false).html("<i class=\"fa fa-check\"></i> SALVAR").removeClass("btn-warning");
                    }
...
var id = urlParams.get('app_codigo');
