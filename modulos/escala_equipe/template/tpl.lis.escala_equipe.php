<?php
include_once("modulos/escala_equipe/template/js.lis.escala_equipe.php");
$_SESSION["FILTRO_ESCALA_EQUIPE"] = $_REQUEST;
...
$objEscalaEquipe = new EscalaEquipe();
$listar = $objEscalaEquipe->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_escala_equipe";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["escala_equipe"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridEscalaEquipe";
$grid->funcao_modificar = "ModificarEscalaEquipe";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroEscalaEquipe";
$grid->id_botao_excluir = "ExcluirRegistroEscalaEquipe";
$grid->id_checkbox_master = "master_EscalaEquipe";
$grid->nome_lista_checkbox = "lista_EscalaEquipe";
$grid->pagina = $pagina;
