...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Escala Equipe</h3>
        ...
        <div class="card-body" id="formulario_escala_equipe">
        <?php include_once("modulos/escala_equipe/template/tpl.form.escala_equipe.php");?>
...
<?php
include_once("modulos/escala_equipe/template/js.frm.escala_equipe.php");
?>
