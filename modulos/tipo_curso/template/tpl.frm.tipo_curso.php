...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Tipos de Cursos</h3>
        ...
        <div class="card-body" id="formulario_tipo_curso">
        <?php include_once("modulos/tipo_curso/template/tpl.form.tipo_curso.php");?>
...
<?php
include_once("modulos/tipo_curso/template/js.frm.tipo_curso.php");
?>
