...
<script type="text/javascript">
    ...
    function AtualizarGridRelatorio(pagina,busca,filtro,ordem)
    {
        ...
        $('#filtro').val(filtro);
        $('#ordem').val(ordem);
        $("#conteudo_relatorio").load("index_xml.php?app_modulo=relatorio_pacientes_idade&app_comando=ajax_listar_relatorio_pacientes_idade",$('#frm_relatorio_paciente').serializeArray());
    }
    ...
    function ImprimirRelatorio()
    {
        if (Squall.ValidateForm($("#frm_relatorio_paciente"))) {
            ...
            form.action = "index_print.php?app_modulo=relatorio_pacientes_idade&app_comando=relatorio_pacientes_idade_print";
            form.target = "_blank";
            form.submit();
        }
    }
    ...
    function GerarPdf()
    {
        if (Squall.ValidateForm($("#frm_relatorio_paciente"))) {
            var form = document.frm_relatorio_paciente;
            form.action = "index_file.php?app_modulo=relatorio_pacientes_idade&app_comando=relatorio_pacientes_idade_pdf";
            form.target = "_blank";
            form.submit();
        }
    }
    ...
    function GerarXml()
    {
        if (Squall.ValidateForm($("#frm_relatorio_paciente"))) {
            var form = document.frm_relatorio_paciente;
            form.action = "index_file.php?app_modulo=relatorio_pacientes_idade&app_comando=relatorio_pacientes_idade_xlsx";
            form.target = "_blank";
            form.submit();
        }
    }
