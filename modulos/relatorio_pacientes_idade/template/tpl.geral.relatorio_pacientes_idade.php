<?php
include("modulos/relatorio_pacientes_idade/template/js.relatorio_pacientes_idade.php");
$objApp = new App();
$configTitulo['titulo_agrupamento_modulo'] = "Relatórios";
$configTitulo['titulo_modulo'] = "Pacientes por Idade";
echo $objApp->GerarBreadCrumb($configTitulo);

?>
    <form action="#" method="post" id="frm_relatorio_paciente" name="frm_relatorio_paciente">
        <input type="hidden" name="pagina" id="pagina" value="<?=$_SESSION['FILTRO_RELATORIO_PACIENTE_IDADE']['pagina']?>">
        <input type="hidden" name="ordem" id="ordem" value="<?=$_SESSION['FILTRO_RELATORIO_PACIENTE_IDADE']['ordem']?>">
        <input type="hidden" name="filtro" id="filtro" value="<?=$_SESSION['FILTRO_RELATORIO_PACIENTE_IDADE']['filtro']?>">
        <input type="hidden" name="retomar_filtro" id="retomar_filtro" value="<?=$_SESSION['FILTRO_RELATORIO_PACIENTE_IDADE']['retomar_filtro']?>">
        <input type="hidden" name="numero_registro_hidden" id="numero_registro_hidden" value="<?=$_SESSION['FILTRO_RELATORIO_PACIENTE_IDADE']['numero_registro_hidden']?>">
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-2">
                            <div class="form-group">
                                ...
                                echo Componente::GerarSelectPDO("id_base", "id_base", "", $lista, array($_SESSION['FILTRO_RELATORIO_PACIENTE_IDADE']['id_base']), array('','Todas as Bases'), array("id", "nome"), false, 'form-select  m-b-20 m-r-10','"');
                                ?>
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="form-group">
                                ...
                                echo Componente::GerarSelectPDO("id_estado", "id_estado", "", $registros, array($_SESSION['FILTRO_RELATORIO_PACIENTE_IDADE']['id_estado']), array('','Todos os Estados'), array("id", "nome"), false, 'form-select  m-b-20 m-r-10',' '.$onchange . $outros);
                                ?>
                            </div>
                        </div>
                        <!--/span-->
                        <div class="col-md-3 mb-4">
                            <div class="form-group">
                                ...
                                echo Componente::GerarSelectPDO("id_cidade","id_cidade","",$registros,array($_SESSION['FILTRO_RELATORIO_PACIENTE_IDADE']['id_cidade']),Array(),Array("id", "nome"),false, "form-select  m-b-20 m-r-10 ",''.$outros);
                                ?>
                            </div>
                        </div>
                        <div class="col-md-3   ">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-5">
                                    <input type="text" class="form-control mask-data  validar-obrigatorio" placeholder="selecione um data" name="periodo"  value="<?=$_SESSION['FILTRO_RELATORIO_PACIENTE_IDADE']['periodo']?>"  id="periodo" aria-label="Todos os Períodos" aria-describedby="basic-addon2">
                        ...
                        <div class="col-md-2 mb-2">
                            <div class="form-group">
                                ...
                                $registros = $objSubEvento->ListarComboSubEventos($_SESSION['FILTRO_RELATORIO_PACIENTE_IDADE']['id_subevento']);
                                ...
                                echo Componente::GerarSelectPDO("id_subevento", "id_subevento", "", $lista, array($_SESSION['FILTRO_RELATORIO_PACIENTE_IDADE']['id_subevento']), array(), array("id", "nome"), false, 'form-select  m-b-20 m-r-10',' '.$outros);
                                ?>
                                <!--                                            <input type="text" name="id_subevento"  id="id_subevento"  class="form-control  " value="--><?//=$_SESSION['FILTRO_RELATORIO_PACIENTE_IDADE']['id_subevento'];?><!--"/>-->
