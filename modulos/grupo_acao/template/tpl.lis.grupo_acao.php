<?
include_once("modulos/grupo_acao/template/js.lis.grupo_acao.php");
...
$dados_tabela["id"]    = "id_tabela_grupo_acao";

$dados_coluna["dados_th"][] = ["configuracao" => "config_caixa_selecao", "nome" => "box", "class"=> "checkboxes","width" => "40"];
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "CUSTOMIZADA","filtro"=> "customizada", "tipo"=> "$ordem"];
...
if(@count($listar[0])> 0){
	foreach($listar[0] as $linha){
		...
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["customizada"]];
...
$grid->titulo = "";
$grid->funcao_atualizar = "AtualizarGridGrupoAcao";
$grid->funcao_modificar = "ModificarGrupoAcao";
