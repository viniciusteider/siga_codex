...
$(document).ready(function () {
    $("#bt_salvar").click(function () {
        ...
        if(id != "")
        {
            url = "index_xml.php?app_modulo=escala_mensal&app_comando=atualizar_escala_mensal&app_codigo";
        }
        else
        {
            url = "index_xml.php?app_modulo=escala_mensal&app_comando=adicionar_escala_mensal&app_codigo";
        }
