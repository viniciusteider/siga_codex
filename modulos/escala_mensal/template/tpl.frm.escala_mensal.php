...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Escalas</h3>
        ...
        <div class="card-body" id="formulario_escala_mensal">
        <?php
        if($_REQUEST['app_codigo'] != "")
            include_once("modulos/escala_mensal/template/tpl.form.escala_mensal2.php");
        else
            include_once("modulos/escala_mensal/template/tpl.form.escala_mensal.php");
...
<?php
include_once("modulos/escala_mensal/template/js.frm.escala_mensal.php");
?>
