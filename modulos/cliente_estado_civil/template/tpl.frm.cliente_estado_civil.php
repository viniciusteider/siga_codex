...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Cliente Estado Civil</h3>
            <div class="card-toolbar">
                <a href='#index_xml.php?app_modulo=cliente_estado_civil&app_comando=listar_cliente_estado_civil'  class="btn btn-sm btn-light "> <i class="fas fa-arrow-circle-left"></i> Voltar para listagem</a>
            </div>
        </div>
        <div class="card-body" id="formulario_cliente_estado_civil">
                <form action="#" name="frm_cliente_estado_civil" id="frm_cliente_estado_civil" method="post">
...
<?
include_once("modulos/cliente_estado_civil/template/js.frm.cliente_estado_civil.php");
?>
