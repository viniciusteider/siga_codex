<?php
include_once("modulos/sinais_clinicos/template/js.lis.sinais_clinicos.php");
$_SESSION["FILTRO_SINAIS_CLINICOS"] = $_REQUEST;
...
$listar = $objSinaisClinicos->ListarPaginacao($parametros);
...
$dados_tabela["id"]    = "id_tabela_sinais_clinicos";
...
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "SINAIS","filtro"=> "sinais", "tipo"=> "$ordem"];
...
if(@count($listar[0])> 0){
	foreach($listar[0] as $linha){
		...
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["sinais"]];
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["sinais_clinicos"]);
$grid = new SquallTable();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridSinaisClinicos";
$grid->funcao_modificar = "ModificarSinaisClinicos";
$grid->id_botao_adicionar = "AdicionarRegistroSinaisClinicos";
$grid->id_botao_excluir = "ExcluirRegistroSinaisClinicos";
$grid->id_checkbox_master = "master_SinaisClinicos";
$grid->nome_lista_checkbox = "lista_SinaisClinicos";
