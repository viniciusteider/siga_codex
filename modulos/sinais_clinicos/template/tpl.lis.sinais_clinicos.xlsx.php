...
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => Sinais];
...
if (@count($listar[0]) > 0) {
	foreach ($listar[0] as $linha) {
		...
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["sinais"],"class"=> "uppercase"];
...
$filtro[ROTULO_LISTAGEM] = Sinais_clinicos;
//$filtro[ROTULO_RELATORIO] = Sinais_clinicos;
...
header("Content-Disposition: attachment;filename=".Sinais_clinicos.".xls");
