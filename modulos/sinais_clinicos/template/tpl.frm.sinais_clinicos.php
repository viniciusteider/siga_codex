...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Sinais Clinicos</h3>
        ...
        <div class="card-body" id="formulario_sinais_clinicos">
        <?php include_once("modulos/sinais_clinicos/template/tpl.form.sinais_clinicos.php");?>
...
<?php
include_once("modulos/sinais_clinicos/template/js.frm.sinais_clinicos.php");
?>
