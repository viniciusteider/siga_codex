<?php
include_once("modulos/pessoal/template/js.lis.pessoal.php");
$_SESSION["FILTRO_PESSOAL"] = $_REQUEST;
...
$listar = $objPessoal->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_pessoal";
...
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "DATA_HORA_CDASTRO","filtro"=> "data_hora_cdastro", "tipo"=> "$ordem"];
...
if(@count($listar[0])> 0){
	foreach($listar[0] as $linha){
		...
		$dados_linha[$x]["dados_td"][] = ["valor" => Conexao::PrepararDataPHP($linha["data_hora_cdastro"], $_SESSION["usuario"]["id_fuso_horario"])];
...
$grid->funcao_atualizar = "AtualizarGridPessoal";
$grid->funcao_modificar = "ModificarPessoal";
