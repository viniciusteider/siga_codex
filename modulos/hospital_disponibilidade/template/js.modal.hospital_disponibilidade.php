...
$(document).ready(function () {
    $("#bt_modal_salvar_hospital_disponibilidade").click(function () {
         var id = $('#id').val();
        var tipo = 1;
...
function ExecutarAcao(url)
{
    ...
    $("#bt_modal_salvar_hospital_disponibilidade").prop("disabled",true).html("<i class=\"fa fa-spin fa-spinner\"></i> Aguarde...").addClass("btn-warning");
       ...
       $('#modal_modulo_hospital_disponibilidade').modal('hide');
                        $('#frm_hospital_disponibilidade').each (function(){
                            this.reset();
                        });
            ...
            $("#bt_modal_salvar_hospital_disponibilidade").prop("disabled",false).html("<i class=\"fa fa-check\"></i> Salvar").removeClass("btn-warning");
			}
