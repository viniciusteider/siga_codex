...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Hospital Disponibilidade</h3>
        ...
        <div class="card-body" id="formulario_hospital_disponibilidade">
        <?php include_once("modulos/hospital_disponibilidade/template/tpl.form.hospital_disponibilidade.php");?>
...
<?php
include_once("modulos/hospital_disponibilidade/template/js.frm.hospital_disponibilidade.php");
?>
