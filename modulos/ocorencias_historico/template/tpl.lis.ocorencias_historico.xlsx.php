...
$listar = $objOcorenciasHistorico->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["ocorencias_historico"]);

$filtro[ROTULO_LISTAGEM] = Ocorencias_historico;
//$filtro[ROTULO_RELATORIO] = Ocorencias_historico;
...
header("Content-Disposition: attachment;filename=".Ocorencias_historico.".xls");
