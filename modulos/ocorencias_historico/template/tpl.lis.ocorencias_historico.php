<?php
include_once("modulos/ocorencias_historico/template/js.lis.ocorencias_historico.php");
$_SESSION["FILTRO_OCORENCIAS_HISTORICO"] = $_REQUEST;
...
$listar = $objOcorenciasHistorico->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_ocorencias_historico";
...
$grid->funcao_atualizar = "AtualizarGridOcorenciasHistorico";
$grid->funcao_modificar = "ModificarOcorenciasHistorico";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroOcorenciasHistorico";
$grid->id_botao_excluir = "ExcluirRegistroOcorenciasHistorico";
$grid->id_checkbox_master = "master_OcorenciasHistorico";
$grid->nome_lista_checkbox = "lista_OcorenciasHistorico";
$grid->pagina = $pagina;
