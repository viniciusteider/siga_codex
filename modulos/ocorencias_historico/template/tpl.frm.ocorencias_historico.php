...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Ocorencias Historico</h3>
        ...
        <div class="card-body" id="formulario_ocorencias_historico">
        <?php include_once("modulos/ocorencias_historico/template/tpl.form.ocorencias_historico.php");?>
...
<?php
include_once("modulos/ocorencias_historico/template/js.frm.ocorencias_historico.php");
?>
