...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Pessoal Punicao</h3>
        ...
        <div class="card-body" id="formulario_pessoal_punicao">
        <?php include_once("modulos/pessoal_punicao/template/tpl.form.pessoal_punicao.php");?>
...
<?php
include_once("modulos/pessoal_punicao/template/js.frm.pessoal_punicao.php");
?>
