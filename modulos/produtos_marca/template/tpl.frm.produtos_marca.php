...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Produtos Marca</h3>
        ...
        <div class="card-body" id="formulario_produtos_marca">
        <?php include_once("modulos/produtos_marca/template/tpl.form.produtos_marca.php");?>
...
<?php
include_once("modulos/produtos_marca/template/js.frm.produtos_marca.php");
?>
