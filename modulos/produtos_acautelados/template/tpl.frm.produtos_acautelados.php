...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Produtos Acautelados</h3>
        ...
        <div class="card-body" id="formulario_produtos_acautelados">
        <?php include_once("modulos/produtos_acautelados/template/tpl.form.produtos_acautelados.php");?>
...
<?php
include_once("modulos/produtos_acautelados/template/js.frm.produtos_acautelados.php");
?>
