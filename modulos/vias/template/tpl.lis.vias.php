<?php
include_once("modulos/vias/template/js.lis.vias.php");
$_SESSION["FILTRO_VIAS"] = $_REQUEST;
...
$objVias = new Vias();
$listar = $objVias->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_vias";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["vias"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridVias";
$grid->funcao_modificar = "ModificarVias";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroVias";
$grid->id_botao_excluir = "ExcluirRegistroVias";
$grid->id_checkbox_master = "master_Vias";
$grid->nome_lista_checkbox = "lista_Vias";
$grid->pagina = $pagina;
