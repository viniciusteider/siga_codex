...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Vias</h3>
        ...
        <div class="card-body" id="formulario_vias">
        <?php include_once("modulos/vias/template/tpl.form.vias.php");?>
...
<?php
include_once("modulos/vias/template/js.frm.vias.php");
?>
