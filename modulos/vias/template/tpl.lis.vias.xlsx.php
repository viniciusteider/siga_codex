...
$objVias = new Vias();
$listar = $objVias->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Vias;
//$filtro[ROTULO_RELATORIO] = Vias;
...
header("Content-Disposition: attachment;filename=".Vias.".xls");
