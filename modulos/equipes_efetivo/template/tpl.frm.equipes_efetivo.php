...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Equipes Efetivo</h3>
        ...
        <div class="card-body" id="formulario_equipes_efetivo">
        <?php include_once("modulos/equipes_efetivo/template/tpl.form.equipes_efetivo.php");?>
...
<?php
include_once("modulos/equipes_efetivo/template/js.frm.equipes_efetivo.php");
?>
