...
$listar = $objEquipesEfetivo->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);

$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => Id];
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => Ordem];
...
$filtro[ROTULO_LISTAGEM] = Equipes_efetivo;
//$filtro[ROTULO_RELATORIO] = Equipes_efetivo;
...
header("Content-Disposition: attachment;filename=".Equipes_efetivo.".xls");
