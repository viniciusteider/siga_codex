<?php
include_once("modulos/equipes_efetivo/template/js.lis.equipes_efetivo.php");
$_SESSION["FILTRO_EQUIPES_EFETIVO"] = $_REQUEST;
...
$listar = $objEquipesEfetivo->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_equipes_efetivo";
...
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "ORDEM","filtro"=> "ordem", "tipo"=> "$ordem"];
...
if(@count($listar[0])> 0){
	foreach($listar[0] as $linha){
		...
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["ordem"]];
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["equipes_efetivo"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridEquipesEfetivo";
$grid->funcao_modificar = "ModificarEquipesEfetivo";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroEquipesEfetivo";
$grid->id_botao_excluir = "ExcluirRegistroEquipesEfetivo";
$grid->id_checkbox_master = "master_EquipesEfetivo";
$grid->nome_lista_checkbox = "lista_EquipesEfetivo";
$grid->pagina = $pagina;
