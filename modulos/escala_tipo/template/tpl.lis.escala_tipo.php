<?php
include_once("modulos/escala_tipo/template/js.lis.escala_tipo.php");
$_SESSION["FILTRO_ESCALA_TIPO"] = $_REQUEST;
...
$objEscalaTipo = new EscalaTipo();
$listar = $objEscalaTipo->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_escala_tipo";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["escala_tipo"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = true;
$grid->funcao_atualizar = "AtualizarGridEscalaTipo";
$grid->funcao_modificar = "ModificarEscalaTipo";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroEscalaTipo";
$grid->id_botao_excluir = "ExcluirRegistroEscalaTipo";
$grid->id_checkbox_master = "master_EscalaTipo";
$grid->nome_lista_checkbox = "lista_EscalaTipo";
$grid->pagina = $pagina;
