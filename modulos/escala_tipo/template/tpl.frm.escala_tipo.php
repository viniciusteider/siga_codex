...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Escala Tipo</h3>
        ...
        <div class="card-body" id="formulario_escala_tipo">
        <?php include_once("modulos/escala_tipo/template/tpl.form.escala_tipo.php");?>
...
<?php
include_once("modulos/escala_tipo/template/js.frm.escala_tipo.php");
?>
