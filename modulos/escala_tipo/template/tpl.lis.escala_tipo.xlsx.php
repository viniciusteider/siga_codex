...
$listar = $objEscalaTipo->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Escala_tipo;
//$filtro[ROTULO_RELATORIO] = Escala_tipo;
...
header("Content-Disposition: attachment;filename=".Escala_tipo.".xls");
