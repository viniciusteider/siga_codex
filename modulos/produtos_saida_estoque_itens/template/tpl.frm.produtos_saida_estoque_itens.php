...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Produtos Saida Estoque Itens</h3>
        ...
        <div class="card-body" id="formulario_produtos_saida_estoque_itens">
        <?php include_once("modulos/produtos_saida_estoque_itens/template/tpl.form.produtos_saida_estoque_itens.php");?>
...
<?php
include_once("modulos/produtos_saida_estoque_itens/template/js.frm.produtos_saida_estoque_itens.php");
?>
