                <form action="#" name="frm_produtos_saida_estoque_itens" id="frm_produtos_saida_estoque_itens" method="post">
			...
			<input type="text" name="id_produto"  id="id_produto" maxlength="" class="form-control  mask-numero" value="<?=$linha['id_produto'];?>"/>
                            ...
                            <div class="col-md-12 mb-2">
                                <div class="form-group">
                                      <label class="form-label" for="id_cautela">Id Cautela:</label>
			<input type="text" name="id_cautela"  id="id_cautela" maxlength="" class="form-control  mask-numero" value="<?=$linha['id_cautela'];?>"/>
                                    <div class="text-muted"> Preencha o campo  Id Cautela </div> 
 </div>
                            </div>
                            <!--/span-->
                            <div class="col-md-12 mb-2">
			...
			<input type="text" name="quantidade"  id="quantidade" maxlength="" class="form-control  mask-numero" value="<?=$linha['quantidade'];?>"/>
                            ...
                            <div class="col-md-12 mb-2">
                                <div class="form-group">
                                      <label class="form-label" for="id_modelo">Id Modelo:</label>
