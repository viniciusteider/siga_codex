<?php
include_once("modulos/produtos_saida_estoque_itens/template/js.lis.produtos_saida_estoque_itens.php");
$_SESSION["FILTRO_PRODUTOS_SAIDA_ESTOQUE_ITENS"] = $_REQUEST;
...
$listar = $objProdutosSaidaEstoqueItens->ListarPaginacao($parametros);
...
$dados_tabela["id"]    = "id_tabela_produtos_saida_estoque_itens";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["produtos_saida_estoque_itens"]);
$grid = new SquallTable();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridProdutosSaidaEstoqueItens";
$grid->funcao_modificar = "ModificarProdutosSaidaEstoqueItens";
$grid->id_botao_adicionar = "AdicionarRegistroProdutosSaidaEstoqueItens";
$grid->id_botao_excluir = "ExcluirRegistroProdutosSaidaEstoqueItens";
$grid->id_checkbox_master = "master_ProdutosSaidaEstoqueItens";
$grid->nome_lista_checkbox = "lista_ProdutosSaidaEstoqueItens";
