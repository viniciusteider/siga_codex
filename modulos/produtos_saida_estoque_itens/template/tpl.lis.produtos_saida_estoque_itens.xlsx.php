...
$filtro[ROTULO_LISTAGEM] = Produtos_saida_estoque_itens;
//$filtro[ROTULO_RELATORIO] = Produtos_saida_estoque_itens;
...
header("Content-Disposition: attachment;filename=".Produtos_saida_estoque_itens.".xls");
