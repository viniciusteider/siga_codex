...
$configTitulo['titulo_modulo'] = "Pessoal Uniforme";
echo $objApp->GerarBreadCrumb($configTitulo);
?>
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Pessoal Uniforme</h3>
        ...
        <div class="card-body" id="formulario_pessoal_uniforme">
        <?php include_once("modulos/pessoal_uniforme/template/tpl.form.pessoal_uniforme.php");?>
...
<?php
include_once("modulos/pessoal_uniforme/template/js.frm.pessoal_uniforme.php");
?>
