...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Almoxarifado</h3>
        ...
        <div class="card-body" id="formulario_almoxarifado">
        <?php include_once("modulos/almoxarifado/template/tpl.form.almoxarifado.php");?>
...
<?php
include_once("modulos/almoxarifado/template/js.frm.almoxarifado.php");
?>
