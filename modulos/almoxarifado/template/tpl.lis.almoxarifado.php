<?php
include_once("modulos/almoxarifado/template/js.lis.almoxarifado.php");
$_SESSION["FILTRO_ALMOXARIFADO"] = $_REQUEST;
...
$listar = $objAlmoxarifado->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_almoxarifado";
...
$grid->funcao_atualizar = "AtualizarGridAlmoxarifado";
$grid->funcao_modificar = "ModificarAlmoxarifado";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroAlmoxarifado";
$grid->id_botao_excluir = "ExcluirRegistroAlmoxarifado";
$grid->id_checkbox_master = "master_Almoxarifado";
$grid->nome_lista_checkbox = "lista_Almoxarifado";
$grid->pagina = $pagina;
