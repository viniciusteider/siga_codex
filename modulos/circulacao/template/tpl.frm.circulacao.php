...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Circulacao</h3>
        ...
        <div class="card-body" id="formulario_circulacao">
        <?php include_once("modulos/circulacao/template/tpl.form.circulacao.php");?>
...
<?php
include_once("modulos/circulacao/template/js.frm.circulacao.php");
?>
