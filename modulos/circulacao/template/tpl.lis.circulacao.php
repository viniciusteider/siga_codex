<?php
include_once("modulos/circulacao/template/js.lis.circulacao.php");
$_SESSION["FILTRO_CIRCULACAO"] = $_REQUEST;
...
$listar = $objCirculacao->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_circulacao";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["circulacao"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridCirculacao";
$grid->funcao_modificar = "ModificarCirculacao";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroCirculacao";
$grid->id_botao_excluir = "ExcluirRegistroCirculacao";
$grid->id_checkbox_master = "master_Circulacao";
$grid->nome_lista_checkbox = "lista_Circulacao";
$grid->pagina = $pagina;
