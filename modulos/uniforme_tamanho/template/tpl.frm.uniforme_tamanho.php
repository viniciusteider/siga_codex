...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Uniforme Tamanho</h3>
        ...
        <div class="card-body" id="formulario_uniforme_tamanho">
        <?php include_once("modulos/uniforme_tamanho/template/tpl.form.uniforme_tamanho.php");?>
...
<?php
include_once("modulos/uniforme_tamanho/template/js.frm.uniforme_tamanho.php");
?>
