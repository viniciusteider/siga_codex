<?php
include_once("modulos/uniforme_tamanho/template/js.lis.uniforme_tamanho.php");
$_SESSION["FILTRO_UNIFORME_TAMANHO"] = $_REQUEST;
...
$objUniformeTamanho = new UniformeTamanho();
$listar = $objUniformeTamanho->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_uniforme_tamanho";
...
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "GRUPO","filtro"=> "nome", "tipo"=> "$ordem"];
...
if(@count($listar[0])> 0){
	foreach($listar[0] as $linha){
		...
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["nome_grupo"]];
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["uniforme_tamanho"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = true;
$grid->funcao_atualizar = "AtualizarGridUniformeTamanho";
$grid->funcao_modificar = "ModificarUniformeTamanho";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroUniformeTamanho";
$grid->id_botao_excluir = "ExcluirRegistroUniformeTamanho";
$grid->id_checkbox_master = "master_UniformeTamanho";
$grid->nome_lista_checkbox = "lista_UniformeTamanho";
$grid->pagina = $pagina;
