...
$listar = $objUniformeTamanho->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Uniforme_tamanho;
//$filtro[ROTULO_RELATORIO] = Uniforme_tamanho;
...
header("Content-Disposition: attachment;filename=".Uniforme_tamanho.".xls");
