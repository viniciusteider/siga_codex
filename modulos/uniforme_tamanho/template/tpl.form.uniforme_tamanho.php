<form action="#" name="frm_uniforme_tamanho" id="frm_uniforme_tamanho" method="post">
        ...
        <div class="row p-t-20">
            <div class="col-md-4 mb-2">
                <div class="form-group">
                    ...
                    echo Componente::GerarSelectPDO("id_uniforme_grupo","id_uniforme_grupo","",$registros,array($linha['id_grupo_tamanhos']),Array("","-- Selecione um Grupo--"),Array("id", "nome"),false, "form-select  ",' data-validar="select2"');
                    ?>
            ...
            <div class="col-md-6 mb-2">
                <div class="form-group">
                    ...
                    <input type="text" name="nome"  id="nome" maxlength="11" class="form-control validar-obrigatorio " value="<?=$linha['nome'];?>"/>
