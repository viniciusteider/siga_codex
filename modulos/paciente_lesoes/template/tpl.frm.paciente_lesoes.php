...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Paciente Lesoes</h3>
        ...
        <div class="card-body" id="formulario_paciente_lesoes">
        <?php include_once("modulos/paciente_lesoes/template/tpl.form.paciente_lesoes.php");?>
...
<?php
include_once("modulos/paciente_lesoes/template/js.frm.paciente_lesoes.php");
?>
