<?php
include_once("modulos/paciente_lesoes/template/js.lis.paciente_lesoes.php");
$_SESSION["FILTRO_PACIENTE_LESOES"] = $_REQUEST;
...
$listar = $objPacienteLesoes->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_paciente_lesoes";
...
$grid->funcao_atualizar = "AtualizarGridPacienteLesoes";
$grid->funcao_modificar = "ModificarPacienteLesoes";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroPacienteLesoes";
$grid->id_botao_excluir = "ExcluirRegistroPacienteLesoes";
$grid->id_checkbox_master = "master_PacienteLesoes";
$grid->nome_lista_checkbox = "lista_PacienteLesoes";
$grid->pagina = $pagina;
