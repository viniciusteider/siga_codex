...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Ocorrencias Recursos</h3>
        ...
        <div class="card-body" id="formulario_ocorrencias_recursos">
        <?php include_once("modulos/ocorrencias_recursos/template/tpl.form.ocorrencias_recursos.php");?>
...
<?php
include_once("modulos/ocorrencias_recursos/template/js.frm.ocorrencias_recursos.php");
?>
