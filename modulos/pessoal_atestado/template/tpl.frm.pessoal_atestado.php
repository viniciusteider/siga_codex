...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Pessoal Atestado</h3>
        ...
        <div class="card-body" id="formulario_pessoal_atestado">
        <?php include_once("modulos/pessoal_atestado/template/tpl.form.pessoal_atestado.php");?>
...
<?php
include_once("modulos/pessoal_atestado/template/js.frm.pessoal_atestado.php");
?>
