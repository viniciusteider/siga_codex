<?php
include_once("modulos/produtos_tipo/template/js.lis.produtos_tipo.php");
$_SESSION["FILTRO_PRODUTOS_TIPO"] = $_REQUEST;
...
$listar = $objProdutosTipo->ListarPaginacao($parametros);
...
$dados_tabela["id"]    = "id_tabela_produtos_tipo";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["produtos_tipo"]);
$grid = new SquallTable();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = true;
$grid->funcao_atualizar = "AtualizarGridProdutosTipo";
$grid->funcao_modificar = "ModificarProdutosTipo";
$grid->id_botao_adicionar = "AdicionarRegistroProdutosTipo";
$grid->id_botao_excluir = "ExcluirRegistroProdutosTipo";
$grid->id_checkbox_master = "master_ProdutosTipo";
$grid->nome_lista_checkbox = "lista_ProdutosTipo";
