...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Produtos Tipo</h3>
        ...
        <div class="card-body" id="formulario_produtos_tipo">
        <?php include_once("modulos/produtos_tipo/template/tpl.form.produtos_tipo.php");?>
...
<?php
include_once("modulos/produtos_tipo/template/js.frm.produtos_tipo.php");
?>
