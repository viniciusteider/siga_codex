...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Paciente Sinais Vitais</h3>
        ...
        <div class="card-body" id="formulario_paciente_sinais_vitais">
        <?php include_once("modulos/paciente_sinais_vitais/template/tpl.form.paciente_sinais_vitais.php");?>
...
<?php
include_once("modulos/paciente_sinais_vitais/template/js.frm.paciente_sinais_vitais.php");
?>
