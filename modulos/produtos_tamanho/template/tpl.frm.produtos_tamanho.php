...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Produtos Tamanho</h3>
        ...
        <div class="card-body" id="formulario_produtos_tamanho">
        <?php include_once("modulos/produtos_tamanho/template/tpl.form.produtos_tamanho.php");?>
...
<?php
include_once("modulos/produtos_tamanho/template/js.frm.produtos_tamanho.php");
?>
