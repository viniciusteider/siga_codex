<?php
include_once("modulos/produtos_tamanho/template/js.lis.produtos_tamanho.php");
$_SESSION["FILTRO_PRODUTOS_TAMANHO"] = $_REQUEST;
...
$listar = $objProdutosTamanho->ListarPaginacao($parametros);
...
$dados_tabela["id"]    = "id_tabela_produtos_tamanho";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["produtos_tamanho"]);
$grid = new SquallTable();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = true;
$grid->funcao_atualizar = "AtualizarGridProdutosTamanho";
$grid->funcao_modificar = "ModificarProdutosTamanho";
$grid->id_botao_adicionar = "AdicionarRegistroProdutosTamanho";
$grid->id_botao_excluir = "ExcluirRegistroProdutosTamanho";
$grid->id_checkbox_master = "master_ProdutosTamanho";
$grid->nome_lista_checkbox = "lista_ProdutosTamanho";
