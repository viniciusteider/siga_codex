<?php
include_once("modulos/hospital/template/js.lis.hospital.php");
$_SESSION["FILTRO_HOSPITAL"] = $_REQUEST;
...
$listar = $objHospital->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_hospital";
...
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "CIDADE","filtro"=> "cidades.nome", "tipo"=> "$ordem"];
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["hospital"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridHospital";
$grid->funcao_modificar = "ModificarHospital";
