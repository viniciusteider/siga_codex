...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Hospital</h3>
        ...
        <div class="card-body" id="formulario_hospital">
            <form action="#" name="frm_hospital" id="frm_hospital" method="post">
                    ...
                    <div class="row p-t-20">
                        ...
                        <div class="col-md-2 mb-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="diretor"  id="diretor" maxlength="100" class="form-control  " value="<?=$linha['diretor'];?>"/>
                                <div class="text-muted"> Preencha o campo  Diretor </div> </div>
                        </div>
                        <div class="col-md-2 mb-2">
                            <div class="form-group">
                                <label class="form-label" for="complexidade">Complexidade</label>
                                <input type="text" name="complexidade"  id="complexidade" maxlength="10" class="form-control  " value="<?=$linha['complexidade'];?>"/>
                                <div class="text-muted"> Preencha o campo  Complexidade </div> </div>
                        </div>
                        <div class="col-md-2 mb-2">
                            <div class="form-group">
                                <label class="form-label" for="vagas_leitos">Vagas Leitos:</label>
                                <input type="text" name="vagas_leitos"  id="vagas_leitos" maxlength="" class="form-control  mask-numero" value="<?=$linha['vagas_leitos'];?>"/>
                                <div class="text-muted"> Preencha o campo  Vagas Leitos </div>
                            </div>
                        </div>
                        <!--/span-->
                        <div class="col-md-2 mb-2">
...
<?php
include_once("modulos/hospital/template/js.frm.hospital.php");
?>
