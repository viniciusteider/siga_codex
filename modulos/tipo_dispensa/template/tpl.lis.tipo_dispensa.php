<?php
include_once("modulos/tipo_dispensa/template/js.lis.tipo_dispensa.php");
$_SESSION["FILTRO_TIPO_DISPENSA"] = $_REQUEST;
...
$objTipoDispensa = new TipoDispensa();
$listar = $objTipoDispensa->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_tipo_dispensa";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["tipo_dispensa"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridTipoDispensa";
$grid->funcao_modificar = "ModificarTipoDispensa";
