...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Tipos de Dispensas</h3>
        ...
        <div class="card-body" id="formulario_tipo_dispensa">
        <?php include_once("modulos/tipo_dispensa/template/tpl.form.tipo_dispensa.php");?>
...
<?php
include_once("modulos/tipo_dispensa/template/js.frm.tipo_dispensa.php");
?>
