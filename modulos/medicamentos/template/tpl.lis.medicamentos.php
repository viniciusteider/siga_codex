<?php
include_once("modulos/medicamentos/template/js.lis.medicamentos.php");
$_SESSION["FILTRO_MEDICAMENTOS"] = $_REQUEST;
...
$listar = $objMedicamentos->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_medicamentos";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["medicamentos"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridMedicamentos";
$grid->funcao_modificar = "ModificarMedicamentos";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroMedicamentos";
$grid->id_botao_excluir = "ExcluirRegistroMedicamentos";
$grid->id_checkbox_master = "master_Medicamentos";
$grid->nome_lista_checkbox = "lista_Medicamentos";
$grid->pagina = $pagina;
