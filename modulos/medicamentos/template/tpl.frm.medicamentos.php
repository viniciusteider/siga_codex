...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Medicamentos</h3>
        ...
        <div class="card-body" id="formulario_medicamentos">
        <?php include_once("modulos/medicamentos/template/tpl.form.medicamentos.php");?>
...
<?php
include_once("modulos/medicamentos/template/js.frm.medicamentos.php");
?>
