...
$listar = $objMedicamentos->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Medicamentos;
//$filtro[ROTULO_RELATORIO] = Medicamentos;
