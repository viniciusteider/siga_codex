...
$filtro[ROTULO_LISTAGEM] = Paciente_sinais_clinicos;
//$filtro[ROTULO_RELATORIO] = Paciente_sinais_clinicos;
...
header("Content-Disposition: attachment;filename=".Paciente_sinais_clinicos.".xls");
