...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Paciente Sinais Clinicos Obstetricia</h3>
        ...
        <div class="card-body" id="formulario_paciente_sinais_clinicos_obstetricia">
        <?php include_once("modulos/paciente_sinais_clinicos_obstetricia/template/tpl.form.paciente_sinais_clinicos_obstetricia.php");?>
...
<?php
include_once("modulos/paciente_sinais_clinicos_obstetricia/template/js.frm.paciente_sinais_clinicos_obstetricia.php");
?>
