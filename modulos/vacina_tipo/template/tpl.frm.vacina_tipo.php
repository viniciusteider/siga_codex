...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Tipos de Vacinas</h3>
        ...
        <div class="card-body" id="formulario_vacina_tipo">
        <?php include_once("modulos/vacina_tipo/template/tpl.form.vacina_tipo.php");?>
...
<?php
include_once("modulos/vacina_tipo/template/js.frm.vacina_tipo.php");
?>
