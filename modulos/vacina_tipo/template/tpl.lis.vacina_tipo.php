<?php
include_once("modulos/vacina_tipo/template/js.lis.vacina_tipo.php");
$_SESSION["FILTRO_VACINA_TIPO"] = $_REQUEST;
...
$listar = $objVacinaTipo->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_vacina_tipo";
...
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "DOSES","filtro"=> "qt_doses", "tipo"=> "$ordem"];
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "INDICAÇÃO","filtro"=> "indicacao", "tipo"=> "$ordem"];
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "INTERVALO","filtro"=> "intervalo_doses", "tipo"=> "$ordem"];
...
if(@count($listar[0])> 0){
	foreach($listar[0] as $linha){
		...
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["qt_doses"]];
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["indicacao"]];
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["intervalo_doses"]];
...
$grid->funcao_atualizar = "AtualizarGridVacinaTipo";
$grid->funcao_modificar = "ModificarVacinaTipo";
