...
$dados_form["name"] = "form_pesquisa_ficha_ocorrencias";
$dados_form["id"] = "form_pesquisa_ficha_ocorrencias";
$dados_form["onsubmit"] = "return false";

$dados_tabela["class"] = "table table-hover";
$dados_tabela["id"] = "tabela_pesquisa_ficha_ocorrencias";
...
if (is_array($listar[0]) && count($listar[0]) > 0) {
    ...
    foreach ($listar[0] as $linha) {
        ...
        $dados_linha[$x]['dados_tr'] = [
            "onclick" => "VisualizarFichaOcorrencia({$linha['id']})",
...
$grid->funcao_atualizar = "AtualizarGridPesquisaFichaOcorrencias";
