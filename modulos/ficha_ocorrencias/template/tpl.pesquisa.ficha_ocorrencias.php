<?php
include "modulos/ficha_ocorrencias/template/js.ficha_ocorrencias.php";
...
$objApp = new App();
$configTitulo['titulo_agrupamento_modulo'] = "Fichas de Ocorrência";
$configTitulo['titulo_modulo'] = "Pesquisa";
echo $objApp->GerarBreadCrumb($configTitulo);
?>
<form action="#" method="post" id="frm_pesquisa_ficha_ocorrencias" name="frm_pesquisa_ficha_ocorrencias">
            ...
            <div class="card-body">
                ...
                <div class="row mt-5">
                    <div class="col-md-12 text-end">
                        <button type="submit" class="btn btn-primary me-2" id="btn-pesquisar-ficha-ocorrencias">
                            <i class="fas fa-search"></i> Pesquisar
                        </button>
                        <button type="button" class="btn btn-light" id="btn-resetar-ficha-pesquisa">
...
$configModulo['id_card'] = "conteudo_pesquisa_ficha_ocorrencias";
