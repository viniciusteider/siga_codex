...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Almoxarifado Setor</h3>
        ...
        <div class="card-body" id="formulario_almoxarifado_setor">
        <?php include_once("modulos/almoxarifado_setor/template/tpl.form.almoxarifado_setor.php");?>
...
<?php
include_once("modulos/almoxarifado_setor/template/js.frm.almoxarifado_setor.php");
?>
