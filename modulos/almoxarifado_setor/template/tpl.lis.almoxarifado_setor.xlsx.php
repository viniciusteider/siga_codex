...
$listar = $objAlmoxarifadoSetor->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Almoxarifado_setor;
//$filtro[ROTULO_RELATORIO] = Almoxarifado_setor;
...
header("Content-Disposition: attachment;filename=".Almoxarifado_setor.".xls");
