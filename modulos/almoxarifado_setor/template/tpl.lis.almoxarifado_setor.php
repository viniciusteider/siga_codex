<?php
include_once("modulos/almoxarifado_setor/template/js.lis.almoxarifado_setor.php");
$_SESSION["FILTRO_ALMOXARIFADO_SETOR"] = $_REQUEST;
...
$listar = $objAlmoxarifadoSetor->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_almoxarifado_setor";
...
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "ALMOXARIFADO","filtro"=> "nome", "tipo"=> "$ordem"];
...
if(@count($listar[0])> 0){
	foreach($listar[0] as $linha){
		...
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["nome_almoxarifado"]];
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["almoxarifado_setor"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = true;
$grid->funcao_atualizar = "AtualizarGridAlmoxarifadoSetor";
$grid->funcao_modificar = "ModificarAlmoxarifadoSetor";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroAlmoxarifadoSetor";
$grid->id_botao_excluir = "ExcluirRegistroAlmoxarifadoSetor";
$grid->id_checkbox_master = "master_AlmoxarifadoSetor";
$grid->nome_lista_checkbox = "lista_AlmoxarifadoSetor";
$grid->pagina = $pagina;
