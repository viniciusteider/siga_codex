...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Paciente Situacao</h3>
        ...
        <div class="card-body" id="formulario_paciente_situacao">
        <?php include_once("modulos/paciente_situacao/template/tpl.form.paciente_situacao.php");?>
...
<?php
include_once("modulos/paciente_situacao/template/js.frm.paciente_situacao.php");
?>
