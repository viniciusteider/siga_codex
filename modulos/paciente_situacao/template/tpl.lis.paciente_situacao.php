<?php
include_once("modulos/paciente_situacao/template/js.lis.paciente_situacao.php");
$_SESSION["FILTRO_PACIENTE_SITUACAO"] = $_REQUEST;
...
$listar = $objPacienteSituacao->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_paciente_situacao";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["paciente_situacao"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = true;
$grid->funcao_atualizar = "AtualizarGridPacienteSituacao";
$grid->funcao_modificar = "ModificarPacienteSituacao";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroPacienteSituacao";
$grid->id_botao_excluir = "ExcluirRegistroPacienteSituacao";
$grid->id_checkbox_master = "master_PacienteSituacao";
$grid->nome_lista_checkbox = "lista_PacienteSituacao";
$grid->pagina = $pagina;
