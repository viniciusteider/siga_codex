...
$listar = $objPacienteSituacao->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Paciente_situacao;
//$filtro[ROTULO_RELATORIO] = Paciente_situacao;
...
header("Content-Disposition: attachment;filename=".Paciente_situacao.".xls");
