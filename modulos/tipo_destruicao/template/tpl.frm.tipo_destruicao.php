...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Tipo Destruicao</h3>
        ...
        <div class="card-body" id="formulario_tipo_destruicao">
        <?php include_once("modulos/tipo_destruicao/template/tpl.form.tipo_destruicao.php");?>
...
<?php
include_once("modulos/tipo_destruicao/template/js.frm.tipo_destruicao.php");
?>
