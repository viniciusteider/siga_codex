<?php
include_once("modulos/tipo_destruicao/template/js.lis.tipo_destruicao.php");
$_SESSION["FILTRO_TIPO_DESTRUICAO"] = $_REQUEST;
...
$listar = $objTipoDestruicao->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_tipo_destruicao";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["tipo_destruicao"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridTipoDestruicao";
$grid->funcao_modificar = "ModificarTipoDestruicao";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroTipoDestruicao";
$grid->id_botao_excluir = "ExcluirRegistroTipoDestruicao";
$grid->id_checkbox_master = "master_TipoDestruicao";
$grid->nome_lista_checkbox = "lista_TipoDestruicao";
$grid->pagina = $pagina;
