...
$listar = $objTipoDestruicao->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Tipo_destruicao;
//$filtro[ROTULO_RELATORIO] = Tipo_destruicao;
...
header("Content-Disposition: attachment;filename=".Tipo_destruicao.".xls");
