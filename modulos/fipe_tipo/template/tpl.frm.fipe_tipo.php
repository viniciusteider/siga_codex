...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Fipe Tipo</h3>
        ...
        <div class="card-body" id="formulario_fipe_tipo">
        <?php include_once("modulos/fipe_tipo/template/tpl.form.fipe_tipo.php");?>
...
<?php
include_once("modulos/fipe_tipo/template/js.frm.fipe_tipo.php");
?>
