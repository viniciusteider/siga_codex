<?php
include_once("modulos/fipe_tipo/template/js.lis.fipe_tipo.php");
$_SESSION["FILTRO_FIPE_TIPO"] = $_REQUEST;
...
$listar = $objFipeTipo->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_fipe_tipo";
...
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "NOME_URL","filtro"=> "nome_url", "tipo"=> "$ordem"];
...
if(@count($listar[0])> 0){
	foreach($listar[0] as $linha){
		...
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["nome_url"]];
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["fipe_tipo"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridFipeTipo";
$grid->funcao_modificar = "ModificarFipeTipo";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroFipeTipo";
$grid->id_botao_excluir = "ExcluirRegistroFipeTipo";
$grid->id_checkbox_master = "master_FipeTipo";
$grid->nome_lista_checkbox = "lista_FipeTipo";
$grid->pagina = $pagina;
