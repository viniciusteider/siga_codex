<?php
include_once("modulos/paciente_procedimentos/template/js.lis.paciente_procedimentos.php");
$_SESSION["FILTRO_PACIENTE_PROCEDIMENTOS"] = $_REQUEST;
...
$listar = $objPacienteProcedimentos->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_paciente_procedimentos";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["paciente_procedimentos"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridPacienteProcedimentos";
$grid->funcao_modificar = "ModificarPacienteProcedimentos";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroPacienteProcedimentos";
$grid->id_botao_excluir = "ExcluirRegistroPacienteProcedimentos";
$grid->id_checkbox_master = "master_PacienteProcedimentos";
$grid->nome_lista_checkbox = "lista_PacienteProcedimentos";
$grid->pagina = $pagina;
