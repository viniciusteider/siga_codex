...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Paciente Procedimentos</h3>
        ...
        <div class="card-body" id="formulario_paciente_procedimentos">
        <?php include_once("modulos/paciente_procedimentos/template/tpl.form.paciente_procedimentos.php");?>
...
<?php
include_once("modulos/paciente_procedimentos/template/js.frm.paciente_procedimentos.php");
?>
