<?php
include_once("modulos/tipo_veiculo/template/js.lis.tipo_veiculo.php");
$_SESSION["FILTRO_TIPO_VEICULO"] = $_REQUEST;
...
$listar = $objTipoVeiculo->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_tipo_veiculo";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["tipo_veiculo"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridTipoVeiculo";
$grid->funcao_modificar = "ModificarTipoVeiculo";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroTipoVeiculo";
$grid->id_botao_excluir = "ExcluirRegistroTipoVeiculo";
$grid->id_checkbox_master = "master_TipoVeiculo";
$grid->nome_lista_checkbox = "lista_TipoVeiculo";
$grid->pagina = $pagina;
