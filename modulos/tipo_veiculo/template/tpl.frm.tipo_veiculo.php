...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Tipo Veiculo</h3>
        ...
        <div class="card-body" id="formulario_tipo_veiculo">
        <?php include_once("modulos/tipo_veiculo/template/tpl.form.tipo_veiculo.php");?>
...
<?php
include_once("modulos/tipo_veiculo/template/js.frm.tipo_veiculo.php");
?>
