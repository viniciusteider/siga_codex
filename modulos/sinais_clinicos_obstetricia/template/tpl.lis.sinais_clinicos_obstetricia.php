<?php
include_once("modulos/sinais_clinicos_obstetricia/template/js.lis.sinais_clinicos_obstetricia.php");
$_SESSION["FILTRO_SINAIS_CLINICOS_OBSTETRICIA"] = $_REQUEST;
...
$listar = $objSinaisClinicosObstetricia->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_sinais_clinicos_obstetricia";
...
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "PROCEDIMENTOS","filtro"=> "procedimentos", "tipo"=> "$ordem"];
...
if(@count($listar[0])> 0){
	foreach($listar[0] as $linha){
		...
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["procedimentos"]];
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["sinais_clinicos_obstetricia"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridSinaisClinicosObstetricia";
$grid->funcao_modificar = "ModificarSinaisClinicosObstetricia";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroSinaisClinicosObstetricia";
$grid->id_botao_excluir = "ExcluirRegistroSinaisClinicosObstetricia";
$grid->id_checkbox_master = "master_SinaisClinicosObstetricia";
$grid->nome_lista_checkbox = "lista_SinaisClinicosObstetricia";
$grid->pagina = $pagina;
