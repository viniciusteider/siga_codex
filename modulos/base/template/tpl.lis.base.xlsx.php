...
$objBase = new Base();
$listar = $objBase->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Base;
//$filtro[ROTULO_RELATORIO] = Base;
