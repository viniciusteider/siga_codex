...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Ocorrencias Materiais</h3>
        ...
        <div class="card-body" id="formulario_ocorrencias_materiais">
        <?php include_once("modulos/ocorrencias_materiais/template/tpl.form.ocorrencias_materiais.php");?>
...
<?php
include_once("modulos/ocorrencias_materiais/template/js.frm.ocorrencias_materiais.php");
?>
