...
$listar = $objFormacao->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Formacao;
//$filtro[ROTULO_RELATORIO] = Formacao;
...
header("Content-Disposition: attachment;filename=".Formacao.".xls");
