...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Produtos Grupo</h3>
        ...
        <div class="card-body" id="formulario_produtos_grupo">
        <?php include_once("modulos/produtos_grupo/template/tpl.form.produtos_grupo.php");?>
...
<?php
include_once("modulos/produtos_grupo/template/js.frm.produtos_grupo.php");
?>
