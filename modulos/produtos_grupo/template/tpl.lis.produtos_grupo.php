<?php
include_once("modulos/produtos_grupo/template/js.lis.produtos_grupo.php");
$_SESSION["FILTRO_PRODUTOS_GRUPO"] = $_REQUEST;
...
$listar = $objProdutosGrupo->ListarPaginacao($parametros);
...
$dados_tabela["id"]    = "id_tabela_produtos_grupo";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["produtos_grupo"]);
$grid = new SquallTable();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = true;
$grid->funcao_atualizar = "AtualizarGridProdutosGrupo";
$grid->funcao_modificar = "ModificarProdutosGrupo";
$grid->id_botao_adicionar = "AdicionarRegistroProdutosGrupo";
$grid->id_botao_excluir = "ExcluirRegistroProdutosGrupo";
$grid->id_checkbox_master = "master_ProdutosGrupo";
$grid->nome_lista_checkbox = "lista_ProdutosGrupo";
