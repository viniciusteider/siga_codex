<?php
include_once("modulos/fipe_anos/template/js.lis.fipe_anos.php");
$_SESSION["FILTRO_FIPE_ANOS"] = $_REQUEST;
...
$listar = $objFipeAnos->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_fipe_anos";
...
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "ANO","filtro"=> "ano", "tipo"=> "$ordem"];
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "COMBUSTIVEL","filtro"=> "combustivel", "tipo"=> "$ordem"];
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "VALOR","filtro"=> "valor", "tipo"=> "$ordem"];
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "MES_REFERENCIA","filtro"=> "mes_referencia", "tipo"=> "$ordem"];
...
if(@count($listar[0])> 0){
	foreach($listar[0] as $linha){
		...
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["ano"]];
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["combustivel"]];
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["valor"]];
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["mes_referencia"]];
...
$grid->funcao_atualizar = "AtualizarGridFipeAnos";
$grid->funcao_modificar = "ModificarFipeAnos";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroFipeAnos";
$grid->id_botao_excluir = "ExcluirRegistroFipeAnos";
$grid->id_checkbox_master = "master_FipeAnos";
$grid->nome_lista_checkbox = "lista_FipeAnos";
$grid->pagina = $pagina;
