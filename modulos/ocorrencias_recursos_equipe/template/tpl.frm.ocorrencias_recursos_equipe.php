...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Ocorrencias Recursos Equipe</h3>
        ...
        <div class="card-body" id="formulario_ocorrencias_recursos_equipe">
        <?php include_once("modulos/ocorrencias_recursos_equipe/template/tpl.form.ocorrencias_recursos_equipe.php");?>
...
<?php
include_once("modulos/ocorrencias_recursos_equipe/template/js.frm.ocorrencias_recursos_equipe.php");
?>
