<?php
include_once("modulos/ocorrencias_recursos_equipe/template/js.lis.ocorrencias_recursos_equipe.php");
$_SESSION["FILTRO_OCORRENCIAS_RECURSOS_EQUIPE"] = $_REQUEST;
...
$listar = $objOcorrenciasRecursosEquipe->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_ocorrencias_recursos_equipe";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["ocorrencias_recursos_equipe"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridOcorrenciasRecursosEquipe";
$grid->funcao_modificar = "ModificarOcorrenciasRecursosEquipe";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroOcorrenciasRecursosEquipe";
$grid->id_botao_excluir = "ExcluirRegistroOcorrenciasRecursosEquipe";
$grid->id_checkbox_master = "master_OcorrenciasRecursosEquipe";
$grid->nome_lista_checkbox = "lista_OcorrenciasRecursosEquipe";
$grid->pagina = $pagina;
