...
$listar = $objCidades->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Cidades;
//$filtro[ROTULO_RELATORIO] = Cidades;
