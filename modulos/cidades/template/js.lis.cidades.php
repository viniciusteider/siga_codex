...
$(document).ready(function(){
	...
	{
        window.location = "#index_xml.php?app_comando=frm_adicionar_cidades&app_modulo=cidades";
	});
...
function ModificarCidades(id){
    window.location = "#index_xml.php?app_comando=frm_atualizar_cidades&app_modulo=cidades&app_codigo="+id;
}
