<?php
include_once("modulos/pupilas_sintomas/template/js.lis.pupilas_sintomas.php");
$_SESSION["FILTRO_PUPILAS_SINTOMAS"] = $_REQUEST;
...
$objPupilasSintomas = new PupilasSintomas();
$listar = $objPupilasSintomas->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_pupilas_sintomas";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["pupilas_sintomas"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridPupilasSintomas";
$grid->funcao_modificar = "ModificarPupilasSintomas";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroPupilasSintomas";
$grid->id_botao_excluir = "ExcluirRegistroPupilasSintomas";
$grid->id_checkbox_master = "master_PupilasSintomas";
$grid->nome_lista_checkbox = "lista_PupilasSintomas";
$grid->pagina = $pagina;
