...
$listar = $objPupilasSintomas->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Pupilas_sintomas;
//$filtro[ROTULO_RELATORIO] = Pupilas_sintomas;
...
header("Content-Disposition: attachment;filename=".Pupilas_sintomas.".xls");
