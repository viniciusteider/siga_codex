...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Classificação de Ligação</h3>
        ...
        <div class="card-body" id="formulario_classificacao_ligacao">
        <?php include_once("modulos/classificacao_ligacao/template/tpl.form.classificacao_ligacao.php");?>
...
<?php
include_once("modulos/classificacao_ligacao/template/js.frm.classificacao_ligacao.php");
?>
