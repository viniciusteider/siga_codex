<?php
include_once("modulos/classificacao_ligacao/template/js.lis.classificacao_ligacao.php");
$_SESSION["FILTRO_CLASSIFICACAO_LIGACAO"] = $_REQUEST;
...
$objClassificacaoLigacao = new ClassificacaoLigacao();
$listar = $objClassificacaoLigacao->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_classificacao_ligacao";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["classificacao_ligacao"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = true;
$grid->funcao_atualizar = "AtualizarGridClassificacaoLigacao";
$grid->funcao_modificar = "ModificarClassificacaoLigacao";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroClassificacaoLigacao";
$grid->id_botao_excluir = "ExcluirRegistroClassificacaoLigacao";
$grid->id_checkbox_master = "master_ClassificacaoLigacao";
$grid->nome_lista_checkbox = "lista_ClassificacaoLigacao";
$grid->pagina = $pagina;
