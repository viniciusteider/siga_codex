...
$filtro[ROTULO_LISTAGEM] = Produtos_saida_estoque;
//$filtro[ROTULO_RELATORIO] = Produtos_saida_estoque;
...
header("Content-Disposition: attachment;filename=".Produtos_saida_estoque.".xls");
