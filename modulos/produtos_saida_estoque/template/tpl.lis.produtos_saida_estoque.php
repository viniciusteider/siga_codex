<?php
include_once("modulos/produtos_saida_estoque/template/js.lis.produtos_saida_estoque.php");
$_SESSION["FILTRO_PRODUTOS_SAIDA_ESTOQUE"] = $_REQUEST;
...
$listar = $objProdutosSaidaEstoque->ListarPaginacao($parametros);
...
$dados_tabela["id"]    = "id_tabela_produtos_saida_estoque";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["produtos_saida_estoque"]);
$grid = new SquallTable();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridProdutosSaidaEstoque";
$grid->funcao_modificar = "ModificarProdutosSaidaEstoque";
$grid->id_botao_adicionar = "AdicionarRegistroProdutosSaidaEstoque";
$grid->id_botao_excluir = "ExcluirRegistroProdutosSaidaEstoque";
$grid->id_checkbox_master = "master_ProdutosSaidaEstoque";
$grid->nome_lista_checkbox = "lista_ProdutosSaidaEstoque";
