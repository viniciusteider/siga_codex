...
$listar = $objTipoSolicitante->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Tipo_solicitante;
//$filtro[ROTULO_RELATORIO] = Tipo_solicitante;
...
header("Content-Disposition: attachment;filename=".Tipo_solicitante.".xls");
