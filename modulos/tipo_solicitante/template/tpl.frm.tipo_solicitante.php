...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Tipo Solicitante</h3>
        ...
        <div class="card-body" id="formulario_tipo_solicitante">
        <?php include_once("modulos/tipo_solicitante/template/tpl.form.tipo_solicitante.php");?>
...
<?php
include_once("modulos/tipo_solicitante/template/js.frm.tipo_solicitante.php");
?>
