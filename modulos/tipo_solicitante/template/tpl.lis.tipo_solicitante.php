<?php
include_once("modulos/tipo_solicitante/template/js.lis.tipo_solicitante.php");
$_SESSION["FILTRO_TIPO_SOLICITANTE"] = $_REQUEST;
...
$objTipoSolicitante = new TipoSolicitante();
$listar = $objTipoSolicitante->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_tipo_solicitante";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["tipo_solicitante"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = true;
$grid->funcao_atualizar = "AtualizarGridTipoSolicitante";
$grid->funcao_modificar = "ModificarTipoSolicitante";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroTipoSolicitante";
$grid->id_botao_excluir = "ExcluirRegistroTipoSolicitante";
$grid->id_checkbox_master = "master_TipoSolicitante";
$grid->nome_lista_checkbox = "lista_TipoSolicitante";
$grid->pagina = $pagina;
