...
$listar = $objAlmoxarifadoCompartimento->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Almoxarifado_compartimento;
//$filtro[ROTULO_RELATORIO] = Almoxarifado_compartimento;
...
header("Content-Disposition: attachment;filename=".Almoxarifado_compartimento.".xls");
