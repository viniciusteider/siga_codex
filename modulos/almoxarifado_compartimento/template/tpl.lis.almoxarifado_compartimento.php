<?php
include_once("modulos/almoxarifado_compartimento/template/js.lis.almoxarifado_compartimento.php");
$_SESSION["FILTRO_ALMOXARIFADO_COMPARTIMENTO"] = $_REQUEST;
...
$listar = $objAlmoxarifadoCompartimento->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_almoxarifado_compartimento";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["almoxarifado_compartimento"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridAlmoxarifadoCompartimento";
$grid->funcao_modificar = "ModificarAlmoxarifadoCompartimento";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroAlmoxarifadoCompartimento";
$grid->id_botao_excluir = "ExcluirRegistroAlmoxarifadoCompartimento";
$grid->id_checkbox_master = "master_AlmoxarifadoCompartimento";
$grid->nome_lista_checkbox = "lista_AlmoxarifadoCompartimento";
$grid->pagina = $pagina;
