...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Almoxarifado Compartimento</h3>
        ...
        <div class="card-body" id="formulario_almoxarifado_compartimento">
        <?php include_once("modulos/almoxarifado_compartimento/template/tpl.form.almoxarifado_compartimento.php");?>
...
<?php
include_once("modulos/almoxarifado_compartimento/template/js.frm.almoxarifado_compartimento.php");
?>
