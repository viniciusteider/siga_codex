            ...
            <div class="card p-4 border-top-left-radius-0 border-top-right-radius-0">
                <form  id="loginform" >
                    <div class="form-group">
                        <p> Digite seu usuário e um e-mail de recuperação será enviado em breve!</p>
                        <input type="text" id="email" name="email"  class="form-control" placeholder="E-mail" >
                        <span class="help-block">Digite seu e-mail</span>
                    </div>
                    <button type="button" id="bt_enviar" class="btn btn-danger float-right">Enviar</button>
                </form>
            </div>
            <div class="blankpage-footer text-center">
                <a href="/link_report"><strong>Voltar para login</strong></a>
            </div>
        </div>
        <div id="div_email_enviado" style="display: none">
            <div class="page-logo m-0 w-100 align-items-left
            rounded border-bottom-left-radius-0 border-bottom-right-radius-0 px-4" style="color: white">
                   Insira o código de segurança
            </div>
            <div class="card p-4 border-top-left-radius-0 border-top-right-radius-0">
                <form id="codigoValidador" >
                    <input type="hidden" id="id_usuario" name="id_usuario">
                    <div class="row ">
                        <div class="col-md-12">
                            <p> Olá, <strong id="nome_usuario" style="color: #DD2C00"></strong>!</p>
                        </div>
                        <div class="col-md-12">
                            <p> Verifique se você recebeu um email contendo seu código. <br/> Seu código tem 6 números.</p>
                        </div>
                        <div class="col-md-6">
                            <input type="text" id="codigo_validador" name="codigo_validador" maxlength="6" class="form-control form-control-lg" placeholder="Insira o código" >
                        </div>
                        <div class="col-md-6">
                            <p> Enviamos seu código para: <br/> <small id="email-txt"></small></p>
                        </div>
                    </div>
                    <div class="row mt-3 mt-3">
                        <div class="col-md-5 pt-2">
                            <a href="#" id="reenviar_codigo">Não recebeu um código?</a>
                        </div>
                        <div class="col-md-7 text-right">
                            <a type="button" id="bt_cancelar" href="/link_report" class="btn btn-default">Cancelar</a>
                            <button type="button" id="bt_continuar" class="btn btn-danger">Continuar</button>
                        </div>
                    </div>
                </form>
            </div>
...
<?include_once ('js.recuperar_senha.php');?>