<?php
include_once("modulos/subevento/template/js.lis.subevento.php");
$_SESSION["FILTRO_SUBEVENTO"] = $_REQUEST;
...
$listar = $objSubevento->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "EVENTO","filtro"=> "nome", "tipo"=> "$ordem"];
