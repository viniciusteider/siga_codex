...
$listar = $objSubevento->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Subevento;
//$filtro[ROTULO_RELATORIO] = Subevento;
...
header("Content-Disposition: attachment;filename=".Subevento.".xls");
