...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Procedimentos</h3>
        ...
        <div class="card-body" id="formulario_procedimentos">
        <?php include_once("modulos/procedimentos/template/tpl.form.procedimentos.php");?>
...
<?php
include_once("modulos/procedimentos/template/js.frm.procedimentos.php");
?>
