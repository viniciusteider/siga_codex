...
$listar = $objEstados->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Estados;
//$filtro[ROTULO_RELATORIO] = Estados;
