...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Produtos Modelo</h3>
        ...
        <div class="card-body" id="formulario_produtos_modelo">
        <?php include_once("modulos/produtos_modelo/template/tpl.form.produtos_modelo.php");?>
...
<?php
include_once("modulos/produtos_modelo/template/js.frm.produtos_modelo.php");
?>
