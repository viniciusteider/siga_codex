<?php
include_once("modulos/produtos_modelo/template/js.lis.produtos_modelo.php");
$_SESSION["FILTRO_PRODUTOS_MODELO"] = $_REQUEST;
...
$listar = $objProdutosModelo->ListarPaginacao($parametros);
...
$dados_tabela["id"]    = "id_tabela_produtos_modelo";
...
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "MARCA","filtro"=> "nome", "tipo"=> "$ordem"];
...
if(@count($listar[0])> 0){
    foreach($listar[0] as $linha){
        ...
        $dados_linha[$x]["dados_td"][] = ["valor" => $linha["nome_marca"]];
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["produtos_modelo"]);
$grid = new SquallTable();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = true;
$grid->funcao_atualizar = "AtualizarGridProdutosModelo";
$grid->funcao_modificar = "ModificarProdutosModelo";
$grid->id_botao_adicionar = "AdicionarRegistroProdutosModelo";
$grid->id_botao_excluir = "ExcluirRegistroProdutosModelo";
$grid->id_checkbox_master = "master_ProdutosModelo";
$grid->nome_lista_checkbox = "lista_ProdutosModelo";
