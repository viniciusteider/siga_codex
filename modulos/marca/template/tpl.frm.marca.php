...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Marca</h3>
            <div class="card-toolbar">
                <a href='#index_xml.php?app_modulo=marca&app_comando=listar_marca'  class="btn btn-sm btn-light "> <i class="fas fa-arrow-circle-left"></i> Voltar para listagem</a>
            </div>
        </div>
        <div class="card-body" id="formulario_marca">
...
<?php
include_once("modulos/marca/template/js.frm.marca.php");
?>
