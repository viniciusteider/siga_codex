<?php
include_once("modulos/marca/template/js.lis.marca.php");
$_SESSION["FILTRO_MARCA"] = $_REQUEST;
...
$objMarca = new Marca();
$listar = $objMarca->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_marca";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["marca"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridMarca";
$grid->funcao_modificar = "ModificarMarca";
