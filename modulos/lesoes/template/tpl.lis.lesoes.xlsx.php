...
$listar = $objLesoes->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Lesoes;
//$filtro[ROTULO_RELATORIO] = Lesoes;
...
header("Content-Disposition: attachment;filename=".Lesoes.".xls");
