...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Lesoes</h3>
        ...
        <div class="card-body" id="formulario_lesoes">
        <?php include_once("modulos/lesoes/template/tpl.form.lesoes.php");?>
...
<?php
include_once("modulos/lesoes/template/js.frm.lesoes.php");
?>
