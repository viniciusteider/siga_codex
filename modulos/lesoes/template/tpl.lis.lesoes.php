<?php
include_once("modulos/lesoes/template/js.lis.lesoes.php");
$_SESSION["FILTRO_LESOES"] = $_REQUEST;
...
$listar = $objLesoes->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_lesoes";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["lesoes"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridLesoes";
$grid->funcao_modificar = "ModificarLesoes";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroLesoes";
$grid->id_botao_excluir = "ExcluirRegistroLesoes";
$grid->id_checkbox_master = "master_Lesoes";
$grid->nome_lista_checkbox = "lista_Lesoes";
$grid->pagina = $pagina;
