...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Pessoal Dispensas</h3>
        ...
        <div class="card-body" id="formulario_pessoal_dispensas">
        <?php include_once("modulos/pessoal_dispensas/template/tpl.form.pessoal_dispensas.php");?>
...
<?php
include_once("modulos/pessoal_dispensas/template/js.frm.pessoal_dispensas.php");
?>
