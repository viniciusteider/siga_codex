...
$configTitulo['titulo_modulo'] = "Classificacao Risco";
echo $objApp->GerarBreadCrumb($configTitulo);
?>
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Classificacao Risco</h3>
        ...
        <div class="card-body" id="formulario_classificacao_risco">
                <form action="#" name="frm_classificacao_risco" id="frm_classificacao_risco" method="post">
...
<?php
include_once("modulos/classificacao_risco/template/js.frm.classificacao_risco.php");
?>
