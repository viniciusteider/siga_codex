<?php
include_once("modulos/classificacao_risco/template/js.lis.classificacao_risco.php");
$_SESSION["FILTRO_CLASSIFICACAO_RISCO"] = $_REQUEST;
...
$objClassificacaoRisco = new ClassificacaoRisco();
$listar = $objClassificacaoRisco->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_classificacao_risco";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["classificacao_risco"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridClassificacaoRisco";
$grid->funcao_modificar = "ModificarClassificacaoRisco";
