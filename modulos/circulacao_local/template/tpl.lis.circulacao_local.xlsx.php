...
$listar = $objCirculacaoLocal->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Circulacao_local;
//$filtro[ROTULO_RELATORIO] = Circulacao_local;
...
header("Content-Disposition: attachment;filename=".Circulacao_local.".xls");
