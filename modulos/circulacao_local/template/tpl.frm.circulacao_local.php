...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Circulacao Local</h3>
        ...
        <div class="card-body" id="formulario_circulacao_local">
        <?php include_once("modulos/circulacao_local/template/tpl.form.circulacao_local.php");?>
...
<?php
include_once("modulos/circulacao_local/template/js.frm.circulacao_local.php");
?>
