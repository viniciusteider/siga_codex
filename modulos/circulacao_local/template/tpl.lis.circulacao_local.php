<?php
include_once("modulos/circulacao_local/template/js.lis.circulacao_local.php");
$_SESSION["FILTRO_CIRCULACAO_LOCAL"] = $_REQUEST;
...
$listar = $objCirculacaoLocal->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_circulacao_local";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["circulacao_local"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridCirculacaoLocal";
$grid->funcao_modificar = "ModificarCirculacaoLocal";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroCirculacaoLocal";
$grid->id_botao_excluir = "ExcluirRegistroCirculacaoLocal";
$grid->id_checkbox_master = "master_CirculacaoLocal";
$grid->nome_lista_checkbox = "lista_CirculacaoLocal";
$grid->pagina = $pagina;
