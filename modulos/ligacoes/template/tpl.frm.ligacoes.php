...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Ligacoes</h3>
        ...
        <div class="card-body" id="formulario_ligacoes">
        <?php include_once("modulos/ligacoes/template/tpl.form.ligacoes.php");?>
...
<?php
include_once("modulos/ligacoes/template/js.frm.ligacoes.php");
?>
