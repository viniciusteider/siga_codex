<?php
include_once("modulos/respiracao/template/js.lis.respiracao.php");
$_SESSION["FILTRO_RESPIRACAO"] = $_REQUEST;
...
$listar = $objRespiracao->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_respiracao";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["respiracao"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridRespiracao";
$grid->funcao_modificar = "ModificarRespiracao";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroRespiracao";
$grid->id_botao_excluir = "ExcluirRegistroRespiracao";
$grid->id_checkbox_master = "master_Respiracao";
$grid->nome_lista_checkbox = "lista_Respiracao";
$grid->pagina = $pagina;
