...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Respiracao</h3>
        ...
        <div class="card-body" id="formulario_respiracao">
        <?php include_once("modulos/respiracao/template/tpl.form.respiracao.php");?>
...
<?php
include_once("modulos/respiracao/template/js.frm.respiracao.php");
?>
