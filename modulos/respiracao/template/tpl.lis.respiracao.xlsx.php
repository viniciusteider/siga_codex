...
$listar = $objRespiracao->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Respiracao;
//$filtro[ROTULO_RELATORIO] = Respiracao;
...
header("Content-Disposition: attachment;filename=".Respiracao.".xls");
