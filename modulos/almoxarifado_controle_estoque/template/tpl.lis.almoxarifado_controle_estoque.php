<?php
include_once("modulos/almoxarifado_controle_estoque/template/js.lis.almoxarifado_controle_estoque.php");
$_SESSION["FILTRO_ALMOXARIFADO_CONTROLE_ESTOQUE"] = $_REQUEST;
...
$listar = $objAlmoxarifadoControleEstoque->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_almoxarifado_controle_estoque";
...
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "QUANTIDADE_ESTOQUE","filtro"=> "quantidade_estoque", "tipo"=> "$ordem"];
...
if(@count($listar[0])> 0){
	foreach($listar[0] as $linha){
		...
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["quantidade_estoque"]];
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["almoxarifado_controle_estoque"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridAlmoxarifadoControleEstoque";
$grid->funcao_modificar = "ModificarAlmoxarifadoControleEstoque";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroAlmoxarifadoControleEstoque";
$grid->id_botao_excluir = "ExcluirRegistroAlmoxarifadoControleEstoque";
$grid->id_checkbox_master = "master_AlmoxarifadoControleEstoque";
$grid->nome_lista_checkbox = "lista_AlmoxarifadoControleEstoque";
$grid->pagina = $pagina;
