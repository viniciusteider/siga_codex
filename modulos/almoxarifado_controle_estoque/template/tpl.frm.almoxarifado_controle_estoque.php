...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Almoxarifado Controle Estoque</h3>
        ...
        <div class="card-body" id="formulario_almoxarifado_controle_estoque">
        <?php include_once("modulos/almoxarifado_controle_estoque/template/tpl.form.almoxarifado_controle_estoque.php");?>
...
<?php
include_once("modulos/almoxarifado_controle_estoque/template/js.frm.almoxarifado_controle_estoque.php");
?>
