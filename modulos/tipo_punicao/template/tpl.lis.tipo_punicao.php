<?php
include_once("modulos/tipo_punicao/template/js.lis.tipo_punicao.php");
$_SESSION["FILTRO_TIPO_PUNICAO"] = $_REQUEST;
...
$objTipoPunicao = new TipoPunicao();
$listar = $objTipoPunicao->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_tipo_punicao";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["tipo_punicao"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridTipoPunicao";
$grid->funcao_modificar = "ModificarTipoPunicao";
