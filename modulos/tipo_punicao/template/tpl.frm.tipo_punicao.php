...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Tipo Punicao</h3>
        ...
        <div class="card-body" id="formulario_tipo_punicao">
        <?php include_once("modulos/tipo_punicao/template/tpl.form.tipo_punicao.php");?>
...
<?php
include_once("modulos/tipo_punicao/template/js.frm.tipo_punicao.php");
?>
