...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Veiculos Acidentes</h3>
        ...
        <div class="card-body" id="formulario_veiculos_acidentes">
        <?php include_once("modulos/veiculos_acidentes/template/tpl.form.veiculos_acidentes.php");?>
...
<?php
include_once("modulos/veiculos_acidentes/template/js.frm.veiculos_acidentes.php");
?>
