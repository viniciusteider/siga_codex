...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Paciente Medicamentos</h3>
        ...
        <div class="card-body" id="formulario_paciente_medicamentos">
        <?php include_once("modulos/paciente_medicamentos/template/tpl.form.paciente_medicamentos.php");?>
...
<?php
include_once("modulos/paciente_medicamentos/template/js.frm.paciente_medicamentos.php");
?>
