<?php
include_once("modulos/funcao/template/js.lis.funcao.php");
$_SESSION["FILTRO_FUNCAO"] = $_REQUEST;
...
$listar = $objFuncao->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_funcao";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["funcao"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridFuncao";
$grid->funcao_modificar = "ModificarFuncao";
