...
$listar = $objFuncao->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Funcao;
//$filtro[ROTULO_RELATORIO] = Funcao;
...
header("Content-Disposition: attachment;filename=".Funcao.".xls");
