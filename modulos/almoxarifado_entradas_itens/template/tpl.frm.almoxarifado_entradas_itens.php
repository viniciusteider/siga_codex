...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Almoxarifado Entradas Itens</h3>
...
<?php
include_once("modulos/almoxarifado_entradas_itens/template/js.frm.almoxarifado_entradas_itens.php");
?>
