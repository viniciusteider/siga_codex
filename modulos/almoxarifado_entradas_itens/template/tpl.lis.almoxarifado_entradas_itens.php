<?php
include_once("modulos/almoxarifado_entradas_itens/template/js.lis.almoxarifado_entradas_itens.php");
$_SESSION["FILTRO_ALMOXARIFADO_ENTRADAS_ITENS"] = $_REQUEST;
...
$listar = $objAlmoxarifadoEntradasItens->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_almoxarifado_entradas_itens";
...
$grid->funcao_atualizar = "AtualizarGridAlmoxarifadoEntradasItens";
$grid->funcao_modificar = "ModificarAlmoxarifadoEntradasItens";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroAlmoxarifadoEntradasItens";
$grid->id_botao_excluir = "ExcluirRegistroAlmoxarifadoEntradasItens";
$grid->id_checkbox_master = "master_AlmoxarifadoEntradasItens";
$grid->nome_lista_checkbox = "lista_AlmoxarifadoEntradasItens";
$grid->pagina = $pagina;
