...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Tipo Recursos</h3>
        ...
        <div class="card-body" id="formulario_tipo_recursos">
        <?php include_once("modulos/tipo_recursos/template/tpl.form.tipo_recursos.php");?>
...
<?php
include_once("modulos/tipo_recursos/template/js.frm.tipo_recursos.php");
?>
