<?php
include_once("modulos/tipo_recursos/template/js.lis.tipo_recursos.php");
$_SESSION["FILTRO_TIPO_RECURSOS"] = $_REQUEST;
...
$objTipoRecursos = new TipoRecursos();
$listar = $objTipoRecursos->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_tipo_recursos";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["tipo_recursos"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridTipoRecursos";
$grid->funcao_modificar = "ModificarTipoRecursos";
