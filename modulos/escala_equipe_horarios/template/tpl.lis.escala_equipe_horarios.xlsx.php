...
$listar = $objEscalaEquipeHorarios->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Escala_equipe_horarios;
//$filtro[ROTULO_RELATORIO] = Escala_equipe_horarios;
...
header("Content-Disposition: attachment;filename=".Escala_equipe_horarios.".xls");
