...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Escala Equipe Horarios</h3>
        ...
        <div class="card-body" id="formulario_escala_equipe_horarios">
        <?php include_once("modulos/escala_equipe_horarios/template/tpl.form.escala_equipe_horarios.php");?>
...
<?php
include_once("modulos/escala_equipe_horarios/template/js.frm.escala_equipe_horarios.php");
?>
