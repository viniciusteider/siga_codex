...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Orgao Apoio</h3>
        ...
        <div class="card-body" id="formulario_orgao_apoio">
        <?php include_once("modulos/orgao_apoio/template/tpl.form.orgao_apoio.php");?>
...
<?php
include_once("modulos/orgao_apoio/template/js.frm.orgao_apoio.php");
?>
