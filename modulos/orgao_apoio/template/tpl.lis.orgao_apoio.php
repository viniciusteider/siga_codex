<?php
include_once("modulos/orgao_apoio/template/js.lis.orgao_apoio.php");
$_SESSION["FILTRO_ORGAO_APOIO"] = $_REQUEST;
...
$listar = $objOrgaoApoio->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_orgao_apoio";
...
if(@count($listar[0])> 0){
	foreach($listar[0] as $linha){
		...
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["ativo"]];
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["orgao_apoio"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridOrgaoApoio";
$grid->funcao_modificar = "ModificarOrgaoApoio";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroOrgaoApoio";
$grid->id_botao_excluir = "ExcluirRegistroOrgaoApoio";
$grid->id_checkbox_master = "master_OrgaoApoio";
$grid->nome_lista_checkbox = "lista_OrgaoApoio";
$grid->pagina = $pagina;
