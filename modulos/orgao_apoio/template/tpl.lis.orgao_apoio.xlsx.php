...
$listar = $objOrgaoApoio->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);

$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => Id];
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => Nome];
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => Ativo];
...
$filtro[ROTULO_LISTAGEM] = Orgao_apoio;
//$filtro[ROTULO_RELATORIO] = Orgao_apoio;
...
header("Content-Disposition: attachment;filename=".Orgao_apoio.".xls");
