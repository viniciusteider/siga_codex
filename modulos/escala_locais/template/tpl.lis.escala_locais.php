<?php
include_once("modulos/escala_locais/template/js.lis.escala_locais.php");
$_SESSION["FILTRO_ESCALA_LOCAIS"] = $_REQUEST;
...
$objEscalaLocais = new EscalaLocais();
$listar = $objEscalaLocais->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_escala_locais";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["escala_locais"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = true;
$grid->funcao_atualizar = "AtualizarGridEscalaLocais";
$grid->funcao_modificar = "ModificarEscalaLocais";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroEscalaLocais";
$grid->id_botao_excluir = "ExcluirRegistroEscalaLocais";
$grid->id_checkbox_master = "master_EscalaLocais";
$grid->nome_lista_checkbox = "lista_EscalaLocais";
$grid->pagina = $pagina;
