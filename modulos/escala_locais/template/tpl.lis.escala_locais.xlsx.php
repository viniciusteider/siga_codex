...
$listar = $objEscalaLocais->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Escala_locais;
//$filtro[ROTULO_RELATORIO] = Escala_locais;
...
header("Content-Disposition: attachment;filename=".Escala_locais.".xls");
