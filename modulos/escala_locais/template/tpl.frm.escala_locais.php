...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Escala Locais</h3>
        ...
        <div class="card-body" id="formulario_escala_locais">
        <?php include_once("modulos/escala_locais/template/tpl.form.escala_locais.php");?>
...
<?php
include_once("modulos/escala_locais/template/js.frm.escala_locais.php");
?>
