...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Fornecedor</h3>
        ...
        <div class="card-body" id="formulario_fornecedor">
        <?php include_once("modulos/fornecedor/template/tpl.form.fornecedor.php");?>
...
<?php
include_once("modulos/fornecedor/template/js.frm.fornecedor.php");
?>
