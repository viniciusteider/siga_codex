...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Instituição de Ensino</h3>
        ...
        <div class="card-body" id="formulario_instituicao_ensino">
        <?php include_once("modulos/instituicao_ensino/template/tpl.form.instituicao_ensino.php");?>
...
<?php
include_once("modulos/instituicao_ensino/template/js.frm.instituicao_ensino.php");
?>
