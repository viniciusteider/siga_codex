...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Tipo Obstetricia</h3>
        ...
        <div class="card-body" id="formulario_tipo_obstetricia">
        <?php include_once("modulos/tipo_obstetricia/template/tpl.form.tipo_obstetricia.php");?>
...
<?php
include_once("modulos/tipo_obstetricia/template/js.frm.tipo_obstetricia.php");
?>
