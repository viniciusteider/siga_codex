...
$objTipoObstetricia = new TipoObstetricia();
$listar = $objTipoObstetricia->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["tipo_obstetricia"]);

$filtro[ROTULO_LISTAGEM] = Tipo_obstetricia;
//$filtro[ROTULO_RELATORIO] = Tipo_obstetricia;
...
header("Content-Disposition: attachment;filename=".Tipo_obstetricia.".xls");
