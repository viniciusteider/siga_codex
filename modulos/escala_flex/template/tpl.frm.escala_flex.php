...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        ...
        <div class="card-body" id="formulario_escala_flex">
        <?php
        if($_REQUEST['app_codigo'] != "")
            include_once("modulos/escala_flex/template/tpl.form.escala_flex2.php");
        else
            include_once("modulos/escala_flex/template/tpl.form.escala_flex.php");
...
<?php
include_once("modulos/escala_flex/template/js.frm.escala_flex.php");
?>
