<?php
include_once("modulos/fipe_marcas/template/js.lis.fipe_marcas.php");
$_SESSION["FILTRO_FIPE_MARCAS"] = $_REQUEST;
...
$listar = $objFipeMarcas->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_fipe_marcas";
...
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "CODIGO_MARCA","filtro"=> "codigo_marca", "tipo"=> "$ordem"];
...
if(@count($listar[0])> 0){
	foreach($listar[0] as $linha){
		...
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["codigo_marca"]];
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["fipe_marcas"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridFipeMarcas";
$grid->funcao_modificar = "ModificarFipeMarcas";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroFipeMarcas";
$grid->id_botao_excluir = "ExcluirRegistroFipeMarcas";
$grid->id_checkbox_master = "master_FipeMarcas";
$grid->nome_lista_checkbox = "lista_FipeMarcas";
$grid->pagina = $pagina;
