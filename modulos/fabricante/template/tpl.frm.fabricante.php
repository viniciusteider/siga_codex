...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Fabricante</h3>
        ...
        <div class="card-body" id="formulario_fabricante">
        <?php include_once("modulos/fabricante/template/tpl.form.fabricante.php");?>
...
<?php
include_once("modulos/fabricante/template/js.frm.fabricante.php");
?>
