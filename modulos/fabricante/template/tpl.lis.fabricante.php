<?php
include_once("modulos/fabricante/template/js.lis.fabricante.php");
$_SESSION["FILTRO_FABRICANTE"] = $_REQUEST;
...
$dados_tabela["id"]    = "id_tabela_fabricante";
...
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "CONTATOS TÉCNICOS","filtro"=> "contatos_tecnicos", "tipo"=> "$ordem"];
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "CONTATOS COMERCIAIS","filtro"=> "contatos_comerciais", "tipo"=> "$ordem"];
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "OBS","filtro"=> "observacoes", "tipo"=> "$ordem"];
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "LIBERADO","filtro"=> "liberado", "tipo"=> "$ordem"];
...
if(@count($listar[0])> 0){
	foreach($listar[0] as $linha){
		...
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["contatos_tecnicos"]];
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["contatos_comerciais"]];
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["observacoes"]];
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["liberado"]];
...
$grid->funcao_atualizar = "AtualizarGridFabricante";
$grid->funcao_modificar = "ModificarFabricante";
$grid->id_botao_adicionar = "AdicionarRegistroFabricante";
$grid->id_botao_excluir = "ExcluirRegistroFabricante";
$grid->id_checkbox_master = "master_Fabricante";
$grid->nome_lista_checkbox = "lista_Fabricante";
