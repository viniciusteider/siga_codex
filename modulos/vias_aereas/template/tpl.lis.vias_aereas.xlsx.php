...
$listar = $objViasAereas->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Vias_aereas;
//$filtro[ROTULO_RELATORIO] = Vias_aereas;
...
header("Content-Disposition: attachment;filename=".Vias_aereas.".xls");
