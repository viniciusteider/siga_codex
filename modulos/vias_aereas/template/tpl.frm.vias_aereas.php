...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Vias Aereas</h3>
        ...
        <div class="card-body" id="formulario_vias_aereas">
        <?php include_once("modulos/vias_aereas/template/tpl.form.vias_aereas.php");?>
...
<?php
include_once("modulos/vias_aereas/template/js.frm.vias_aereas.php");
?>
