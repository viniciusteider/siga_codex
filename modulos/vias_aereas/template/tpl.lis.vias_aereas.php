<?php
include_once("modulos/vias_aereas/template/js.lis.vias_aereas.php");
$_SESSION["FILTRO_VIAS_AEREAS"] = $_REQUEST;
...
$listar = $objViasAereas->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_vias_aereas";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["vias_aereas"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridViasAereas";
$grid->funcao_modificar = "ModificarViasAereas";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroViasAereas";
$grid->id_botao_excluir = "ExcluirRegistroViasAereas";
$grid->id_checkbox_master = "master_ViasAereas";
$grid->nome_lista_checkbox = "lista_ViasAereas";
$grid->pagina = $pagina;
