...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Paciente Circulacao</h3>
        ...
        <div class="card-body" id="formulario_paciente_circulacao">
        <?php include_once("modulos/paciente_circulacao/template/tpl.form.paciente_circulacao.php");?>
...
<?php
include_once("modulos/paciente_circulacao/template/js.frm.paciente_circulacao.php");
?>
