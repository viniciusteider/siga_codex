<?php
include_once("modulos/paciente_circulacao/template/js.lis.paciente_circulacao.php");
$_SESSION["FILTRO_PACIENTE_CIRCULACAO"] = $_REQUEST;
...
$listar = $objPacienteCirculacao->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_paciente_circulacao";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["paciente_circulacao"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridPacienteCirculacao";
$grid->funcao_modificar = "ModificarPacienteCirculacao";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroPacienteCirculacao";
$grid->id_botao_excluir = "ExcluirRegistroPacienteCirculacao";
$grid->id_checkbox_master = "master_PacienteCirculacao";
$grid->nome_lista_checkbox = "lista_PacienteCirculacao";
$grid->pagina = $pagina;
