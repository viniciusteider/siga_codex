<?php
include_once("modulos/prefixo/template/js.lis.prefixo.php");
$_SESSION["FILTRO_PREFIXO"] = $_REQUEST;
...
$listar = $objPrefixo->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_prefixo";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["prefixo"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridPrefixo";
$grid->funcao_modificar = "ModificarPrefixo";
