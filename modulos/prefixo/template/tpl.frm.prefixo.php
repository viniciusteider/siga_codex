...
$configTitulo['titulo_modulo'] = "Prefixo";
echo $objApp->GerarBreadCrumb($configTitulo);
?>
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Prefixo</h3>
        ...
        <div class="card-body" id="formulario_prefixo">
            <form action="#" name="frm_prefixo" id="frm_prefixo" method="post">
...
<?php
include_once("modulos/prefixo/template/js.frm.prefixo.php");
?>
