...
$listar = $objPrefixo->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Prefixo;
//$filtro[ROTULO_RELATORIO] = Prefixo;
...
header("Content-Disposition: attachment;filename=".Prefixo.".xls");
