<?php
include_once("modulos/equipes/template/js.lis.equipes.php");
$_SESSION["FILTRO_EQUIPES"] = $_REQUEST;
...
$listar = $objEquipes->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_equipes";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["equipes"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridEquipes";
$grid->funcao_modificar = "ModificarEquipes";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroEquipes";
$grid->id_botao_excluir = "ExcluirRegistroEquipes";
$grid->id_checkbox_master = "master_Equipes";
$grid->nome_lista_checkbox = "lista_Equipes";
$grid->pagina = $pagina;
