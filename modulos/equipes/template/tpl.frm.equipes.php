...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Equipes</h3>
        ...
        <div class="card-body" id="formulario_equipes">
        <?php include_once("modulos/equipes/template/tpl.form.equipes.php");?>
...
<?php
include_once("modulos/equipes/template/js.frm.equipes.php");
?>
