...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Estagio Parto</h3>
        ...
        <div class="card-body" id="formulario_estagio_parto">
        <?php include_once("modulos/estagio_parto/template/tpl.form.estagio_parto.php");?>
...
<?php
include_once("modulos/estagio_parto/template/js.frm.estagio_parto.php");
?>
