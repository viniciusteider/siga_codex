<?php
include_once("modulos/estagio_parto/template/js.lis.estagio_parto.php");
$_SESSION["FILTRO_ESTAGIO_PARTO"] = $_REQUEST;
...
$listar = $objEstagioParto->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_estagio_parto";
...
$grid->funcao_atualizar = "AtualizarGridEstagioParto";
$grid->funcao_modificar = "ModificarEstagioParto";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroEstagioParto";
$grid->id_botao_excluir = "ExcluirRegistroEstagioParto";
$grid->id_checkbox_master = "master_EstagioParto";
$grid->nome_lista_checkbox = "lista_EstagioParto";
$grid->pagina = $pagina;
