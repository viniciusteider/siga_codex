...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Evento</h3>
        ...
        <div class="card-body" id="formulario_evento">
            <form action="#" name="frm_evento" id="frm_evento" method="post">
...
<?php
include_once("modulos/evento/template/js.frm.evento.php");
?>
