...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Produtos Revestimento</h3>
        ...
        <div class="card-body" id="formulario_produtos_revestimento">
        <?php include_once("modulos/produtos_revestimento/template/tpl.form.produtos_revestimento.php");?>
...
<?php
include_once("modulos/produtos_revestimento/template/js.frm.produtos_revestimento.php");
?>
