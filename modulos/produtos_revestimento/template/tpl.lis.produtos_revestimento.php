<?php
include_once("modulos/produtos_revestimento/template/js.lis.produtos_revestimento.php");
$_SESSION["FILTRO_PRODUTOS_REVESTIMENTO"] = $_REQUEST;
...
$listar = $objProdutosRevestimento->ListarPaginacao($parametros);
...
$dados_tabela["id"]    = "id_tabela_produtos_revestimento";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["produtos_revestimento"]);
$grid = new SquallTable();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = true;
$grid->funcao_atualizar = "AtualizarGridProdutosRevestimento";
$grid->funcao_modificar = "ModificarProdutosRevestimento";
$grid->id_botao_adicionar = "AdicionarRegistroProdutosRevestimento";
$grid->id_botao_excluir = "ExcluirRegistroProdutosRevestimento";
$grid->id_checkbox_master = "master_ProdutosRevestimento";
$grid->nome_lista_checkbox = "lista_ProdutosRevestimento";
