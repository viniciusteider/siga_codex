...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Tipo Combustível</h3>
        ...
        <div class="card-body" id="formulario_tipo_combustivel">
        <?php include_once("modulos/tipo_combustivel/template/tpl.form.tipo_combustivel.php");?>
...
<?php
include_once("modulos/tipo_combustivel/template/js.frm.tipo_combustivel.php");
?>
