<?php
include_once("modulos/tipo_combustivel/template/js.lis.tipo_combustivel.php");
$_SESSION["FILTRO_TIPO_COMBUSTIVEL"] = $_REQUEST;
...
$listar = $objTipoCombustivel->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_tipo_combustivel";
...
$dados_coluna["dados_th"][] = ["configuracao" => "", "nome" => "TIPO_COMBUSTIVEL","filtro"=> "tipo_combustivel", "tipo"=> "$ordem"];
...
if(@count($listar[0])> 0){
	foreach($listar[0] as $linha){
		...
		$dados_linha[$x]["dados_td"][] = ["valor" => $linha["tipo_combustivel"]];
...
$grid->funcao_atualizar = "AtualizarGridTipoCombustivel";
$grid->funcao_modificar = "ModificarTipoCombustivel";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroTipoCombustivel";
$grid->id_botao_excluir = "ExcluirRegistroTipoCombustivel";
$grid->id_checkbox_master = "master_TipoCombustivel";
$grid->nome_lista_checkbox = "lista_TipoCombustivel";
$grid->pagina = $pagina;
