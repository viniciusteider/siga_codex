...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Uniforme Grupo Tamanho</h3>
        ...
        <div class="card-body" id="formulario_uniforme_grupo_tamanho">
        <?php include_once("modulos/uniforme_grupo_tamanho/template/tpl.form.uniforme_grupo_tamanho.php");?>
...
<?php
include_once("modulos/uniforme_grupo_tamanho/template/js.frm.uniforme_grupo_tamanho.php");
?>
