<?php
include_once("modulos/uniforme_grupo_tamanho/template/js.lis.uniforme_grupo_tamanho.php");
$_SESSION["FILTRO_UNIFORME_GRUPO_TAMANHO"] = $_REQUEST;
...
$objUniformeGrupoTamanho = new UniformeGrupoTamanho();
$listar = $objUniformeGrupoTamanho->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_uniforme_grupo_tamanho";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["uniforme_grupo_tamanho"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridUniformeGrupoTamanho";
$grid->funcao_modificar = "ModificarUniformeGrupoTamanho";
$grid->valor_campo_busca = $busca;
$grid->filtro = $filtro;
$grid->id_botao_adicionar = "AdicionarRegistroUniformeGrupoTamanho";
$grid->id_botao_excluir = "ExcluirRegistroUniformeGrupoTamanho";
$grid->id_checkbox_master = "master_UniformeGrupoTamanho";
$grid->nome_lista_checkbox = "lista_UniformeGrupoTamanho";
$grid->pagina = $pagina;
