<?php
include_once("modulos/produtos_sub_grupo/template/js.lis.produtos_sub_grupo.php");
$_SESSION["FILTRO_PRODUTOS_SUB_GRUPO"] = $_REQUEST;
...
$listar = $objProdutosSubGrupo->ListarPaginacao($parametros);
...
$dados_tabela["id"]    = "id_tabela_produtos_sub_grupo";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["produtos_sub_grupo"]);
$grid = new SquallTable();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = true;
$grid->funcao_atualizar = "AtualizarGridProdutosSubGrupo";
$grid->funcao_modificar = "ModificarProdutosSubGrupo";
$grid->id_botao_adicionar = "AdicionarRegistroProdutosSubGrupo";
$grid->id_botao_excluir = "ExcluirRegistroProdutosSubGrupo";
$grid->id_checkbox_master = "master_ProdutosSubGrupo";
$grid->nome_lista_checkbox = "lista_ProdutosSubGrupo";
