...
$filtro[ROTULO_LISTAGEM] = Produtos_sub_grupo;
//$filtro[ROTULO_RELATORIO] = Produtos_sub_grupo;
...
header("Content-Disposition: attachment;filename=".Produtos_sub_grupo.".xls");
