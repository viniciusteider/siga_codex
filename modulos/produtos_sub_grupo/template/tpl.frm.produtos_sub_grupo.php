...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Produtos Sub Grupo</h3>
        ...
        <div class="card-body" id="formulario_produtos_sub_grupo">
        <?php include_once("modulos/produtos_sub_grupo/template/tpl.form.produtos_sub_grupo.php");?>
...
<?php
include_once("modulos/produtos_sub_grupo/template/js.frm.produtos_sub_grupo.php");
?>
