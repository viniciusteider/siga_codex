<?php
include_once("modulos/ocorrencias_status/template/js.lis.ocorrencias_status.php");
$_SESSION["FILTRO_OCORRENCIAS_STATUS"] = $_REQUEST;
...
$objOcorrenciasStatus = new OcorrenciasStatus();
$listar = $objOcorrenciasStatus->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem,$parametros);
...
$dados_tabela["id"]    = "id_tabela_ocorrencias_status";
...
//Componente::FiltrarRelatorioConfiguracao($dados_coluna, $dados_linha, $_SESSION["configuracao_usuario"]["ocorrencias_status"]);
$grid = new GerarGrid();
$grid->form = $dados_form;
$grid->tabela = $dados_tabela;
$grid->titulo = "";
$grid->permitir_busca = false;
$grid->funcao_atualizar = "AtualizarGridOcorrenciasStatus";
$grid->funcao_modificar = "ModificarOcorrenciasStatus";
