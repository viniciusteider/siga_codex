...
$listar = $objOcorrenciasStatus->ListarPaginacao($_SESSION['usuario']['id_grupo'],$numeroRegistros,$numeroInicioRegistro,$busca,$filtro,$ordem);
...
$filtro[ROTULO_LISTAGEM] = Ocorrencias_status;
//$filtro[ROTULO_RELATORIO] = Ocorrencias_status;
...
header("Content-Disposition: attachment;filename=".Ocorrencias_status.".xls");
