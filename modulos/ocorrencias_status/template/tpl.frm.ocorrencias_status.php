...
<div id="kt_app_content_container" class="app-container  p-0">
    <div class="card shadow-sm">
        <div class="card-header">
            <h3 class="card-title"> Formulário Ocorrências Status</h3>
        ...
        <div class="card-body" id="formulario_ocorrencias_status">
            <form action="#" name="frm_ocorrencias_status" id="frm_ocorrencias_status" method="post">
...
<?php
include_once("modulos/ocorrencias_status/template/js.frm.ocorrencias_status.php");
?>
